package com.zfsoft.ha.outer.scanning.Lister;
...
import com.zfsoft.ha.outer.scanning.controller.ScanningController;
...
public class MyLister implements SerialPortEventListener {
    ...
    public void serialEvent(SerialPortEvent arg0) {
        if (arg0.getEventType() == SerialPortEvent.DATA_AVAILABLE) {
            ...
            System.out.println("===========lister==========="+thread.getName());
...
//            System.out.println("UNPACK ISO8583: " + JSON.toJSONString(aiISO8583DTO));
            ...
            ScanningController.result = hexStringToString(needData);
//            ScanningController.object.notify();
            status=true;
