 ...
 * @Date: 2022/8/4 13:43
 */
@RequestMapping("/work/groupSplit")
public interface HaWorkUserGroupSplitService {
    /**
    ...
    ApiResultSet<PageResult<HaWorkGroupSplit>> queryGroupServicePage(
    ...
    ApiResultSet saveWorkUserGroup(@RequestBody HaWorkGroupSplit haWorkGroup) throws Exception;
    ...
    ApiResultSet<List<HaWorkGroupSplit>> queryHaWorkGroupTree(@RequestParam(value = "groupId",required = false)String groupId);
