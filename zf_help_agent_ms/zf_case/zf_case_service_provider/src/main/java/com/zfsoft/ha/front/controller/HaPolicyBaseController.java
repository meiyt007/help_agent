...
import com.zfsoft.cases.feign.CommonFeignService;
import com.zfsoft.ha.data.HaPolicyBase;
import com.zfsoft.ha.front.HaPolicyBaseService;
...
@RestController
@Slf4j
public class HaPolicyBaseController implements HaPolicyBaseService {
    /**
     * 帮代办人员小组(组内分组）表实现层
     */
    @Resource
     ...
     */
    @Resource
    private CommonFeignService commonFeginService;
    ...
    public ApiResultSet<List<TreeSelect>> querySysOrganWithPage(String districtOid){
        //获取机构列表
        return commonFeginService.querySysOrganWithPageFeign(districtOid);
    }
