...
public class HttpConnection {
	...
	public static HttpURLConnection getConnection(URL url, HttpMethod method, HttpHeader header,Optional<Proxy> proxy) throws Exception {
		HttpURLConnection conn = proxy.isPresent()?(HttpURLConnection) url.openConnection(proxy.get()):(HttpURLConnection) url.openConnection();
