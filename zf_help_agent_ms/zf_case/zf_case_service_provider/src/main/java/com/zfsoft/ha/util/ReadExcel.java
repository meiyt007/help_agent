...
public class ReadExcel{
    ...
    public static void main(String[] args) throws Exception {
        ...
        readExcel.getListByExcel(inputStream,"synonym20230315155812.xlsx");
    }
    /**
     * @param in,fileName
     * @return
        ...
        for (int i = 0; i < work.getNumberOfSheets(); i++) {
            ...
            for (int j = sheet.getFirstRowNum(); j <= sheet.getLastRowNum(); j++) {
                ...
                for (int y = row.getFirstCellNum(); y < row.getLastCellNum(); y++) {
                    ...
                    cell = row.getCell(y);
//                    if(y == 0){
//                        map.put("fileName",getValue(cell));
//                    }else if(y == 1){
//                        map.put("answerPureText",getValue(cell));
//                    }else {
//                        map.put("answeRrichText",getValue(cell));
//                    }
