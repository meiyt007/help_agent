...
public class AliSpeechUtil {
    ...
    /**
     * 阿里云智能语音交互appkey 更新为你注册的
     */
    public static final String ALIYUN_SPEECH_APPKEY;
    /**
     * 阿里云账户accessKeyId 更新为你注册的
     */
    public static final String ALIYUN_SPEECH_ACCESSKEYID;
    /**
     * 阿里云账户accessKeySecret 更新为你注册的
     */
    public static final String ALIYUN_SPEECH_ACCESSKEYSECRET;

    /**
     * 阿里云账户创建语音文件接口地址
     */
    public static final String ALIYUN_SPEECH_CREATE_SPEECH_URL;


    static {
        PropertiesUtil pu = new PropertiesUtil("interface_param.properties");
        ALIYUN_SPEECH_APPKEY = pu.readProperty("aliyun.speech.appkey");
        ALIYUN_SPEECH_ACCESSKEYID = pu.readProperty("aliyun.speech.accessKeyId");
        ALIYUN_SPEECH_ACCESSKEYSECRET = pu.readProperty("aliyun.speech.accessKeySecret");
        ALIYUN_SPEECH_CREATE_SPEECH_URL = pu.readProperty("aliyun.speech.createSpeechUrl");
