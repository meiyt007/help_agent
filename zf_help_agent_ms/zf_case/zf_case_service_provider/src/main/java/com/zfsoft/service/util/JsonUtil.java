...
public class JsonUtil {
    ...
    /**
     * 将Map转换成JSON(同时对对象中的日期类型进行处理成yyyy-MM-dd格式)
     * @author zhangh
     * @date 2018年6月11日
     * @param object 需要转化为json的map对象
     * @return
     */
    public static String mapToJsonOfDate(Object object) {
     ...
     * 支持集合和单一对象
     * 示例: JsonUtil.objToJson(list, new Object[]{SysUser.class, "jobNumber", "business", "roomId"});
     * @author:zhujiajian
    ...
    public static List jsonToCollection(String json, Class beanClz) {
        ...
        jsonConfig.registerJsonValueProcessor(Date.class,
                new JsonDateValueProcessor());// 注入处理Date类
        return (List) JSONArray.toList(JSONArray.fromObject(json,jsonConfig), beanClz);
    }
     ...
     *            转化对象
     */
    public static com.alibaba.fastjson.JSONObject objectToJSONObject(Object object) {
        if(null == object){
            return null;
        }
