...
public class FaStaticParam {
   /* 通过*/
    public static final int TRUE_STATUS = 0;
    /*不通过*/
    public static final int FLASE_STATUS = 1;
   /*人工审核*/
    public static final int ARTIFICAL_STATUS = 2;
  /*  public static final String CODE = "code";*/
    ...
    /**  预审结果标识  4:无关联附件*/
    public static final String PRE_TRIAL_RESULT_STATUS_NOT_ATTA = "4";
    /**  预审结果标识  5:无关联目录*/
    public static final String PRE_TRIAL_RESULT_STATUS_NOT_CATE = "5";
    /**  预审结果标识  6:无ocr审核结果 材料不符合智审模板*/
    public static final String PRE_TRIAL_RESULT_STATUS_NOT_RESULT = "6";
    /**  预审结果标识  5:无细化材料*/
    public static final String PRE_TRIAL_RESULT_STATUS_NOT_REFINED = "7";

    /**  预审结果标识 8:智审配置不完全 */
    public static final String PRE_TRIAL_RESULT_STATUS_NO_PEIZHI = "8";

    /**  预审结果标识 9:需人工审核 */
    public static final String PRE_TRIAL_RESULT_STATUS_NEED_MANUAL_AUDIT = "9";


    /**  审核结果标识 0:通过 */
    public static final String EXAMINE_RESULT_STATUS_PASS = "0";
    /**  审核结果标识  1:不通过 */
    public static final String EXAMINE_RESULT_STATUS_NOT_PASS = "1";
    /**  审核结果标识  2:无需智审*/
    public static final String EXAMINEL_RESULT_STATUS_NOT_AUDIT = "2";
    /**  审核结果标识  3:人工审核*/
    public static final String EXAMINEL_RESULT_STATUS_ARTIFICIAL_AUDIT = "3";
    /**  审核结果标识 4:审核通过但部分需要人工审核 */
    public static final String EXAMINE_RESULT_STATUS_PASS_AND_MUST_ARTIFICIAL = "4";
    ...
    /** 内容验证，手写盖章 */
    public static final String VALIDATION_TYPE_SEAL = "SEAL";
   /* 人工验证*/
    public static final String VALIDATION_TYPE_MANUAL_AUDIT = "MANUAL_AUDIT";
    ...
    public static final Map<String, String> SERNUM_MAP = new LinkedHashMap<String, String>();
    ...
    static {
        ...
        VALIDATION_TYPE.put(VALIDATION_TYPE_SEAL, "盖章验证");
  ...
  /*  public static Map<String, TencentAcountVo> TENCENT_AUTH_INFO = new HashMap<String, TencentAcountVo>();*/
    ...
    //** 证照识别类型-身份证混贴 *//*
    public static final String LICE_OCR_TYPE_IDCARD_MIX = "6";
    ...
    static {
        ...
        LICE_OCR_TYPE_MAP.put(LICE_OCR_TYPE_IDCARD_MIX, "身份证混贴");
...
*/
    ...
    //** 百度证照识别类型-身份证 *//
    public static final String tempIdcard = "tempIdcard";

    //** 百度证照识别类型-营业执照 *//
    public static final String businessLicense = "businessLicense";

    //百度Ocr
    public static final String BAIDU_OCR = "0";
    //textInOcr
    public static final String TEXTIN_OCR = "1";
