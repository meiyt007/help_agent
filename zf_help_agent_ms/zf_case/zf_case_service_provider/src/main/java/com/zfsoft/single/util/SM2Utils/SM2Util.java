...
/**
  * @Description: SM2验签、加密
  * @Author: liyanq
  * @Date: 2019-09-18 19:43
  * @Version: 1.0
  * @Company: 版权所有©
  **/
public class SM2Util {
    ...
    /**
     * @Description: 获取ECDomainParameters
     * @Param: []
     * @return: lu.crypto.params.ECDomainParameters
     * @Author: liyanq
     * @Date: 2019-09-18 19:42
     * @Version: 1.0
     * @Company: 版权所有©
    **/
     ...
     * @Company: 版权所有©
    **/
    public static Map<String, String> generateSM2Keys(){
    ...
    /*
     * @Description: SM2公钥加密
     * @Param: [publicKey 公钥字符串, text 需加密的内容]
    ...
    **/
    ...
    /*
     * @Description: SM2私钥解密
     * @Param: [privateKey 私钥字符串, cipherText 需要解密的内容]
     * @return: java.lang.String
     * @Author: liyanq
     * @Date: 2019-09-18 19:45
     * @Version: 1.0
     * @Company: 版权所有©
    **/
    ...
    /**
     * @Description: SM2私钥签名
     * @Param: [privateKey 私钥字符串, withId 关联键, text 需要签名的内容]
     * @return: java.lang.String
     * @Author: liyanq
     * @Date: 2019-09-18 19:45
     * @Version: 1.0
    ...
    **/
    ...
    /**
     * @Description: SM2公钥验签
     * @Param: [publicKey 公钥字符串, withId 关联键, text 需要签名的内容, sign 签名字符串]
     * @return: boolean
     * @Author: liyanq
     * @Date: 2019-09-18 19:45
     * @Version: 1.0
