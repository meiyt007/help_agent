...
public class SysCode {
    ...
    /** 数据权限类型    1 -- 业务人员   2 -- 实施人员 */
    public interface GRANT_USER_TYPE {
        /** 业务人员 */
        Integer BUSINESS = 1;
        /** 实施人员 */
        Integer ADMINISTRATION = 2;

        String BUSINESS_CODE ="GR-D1487902326168";

        String ADMINISTRATION_CODE ="QY-D1487902330767";
