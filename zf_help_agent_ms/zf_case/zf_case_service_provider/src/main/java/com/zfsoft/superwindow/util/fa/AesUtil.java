...
public class AesUtil {
    ...
    //与C#互通的密钥 密钥，长度16
    private static final String CARD_KEY = "zfsoftzfzfsoftzf";
    //与C#互通的偏移量 偏移量，长度16
    private static final String CARD_IV = "2021061881601202";
    ...
    public static String decryptAES(String data) {
        try {
            ...
            SecretKeySpec keyspec = new SecretKeySpec(CARD_KEY.getBytes(), "AES");
            IvParameterSpec ivspec = new IvParameterSpec(CARD_IV.getBytes());
