...
public class FaFileUtil {
    public static String getAbsFilePathBySysAtta(HttpServletRequest request, String sysAttaOid, SysAtta sysAtta) throws Exception {
...
/*    public ApiResultSet download(String attaOid) throws IOException {
     ...
     * @throws Exception
     */
    public static String getAbsFilePathBySysAttaOid(HttpServletRequest request, String sysAttaOid) throws Exception {
        String filePath = null;
    ...
    public static String buildFileSavePath(HttpServletRequest request, String folderName, String fileExt) {
        //String dir = UploadUtil.getRealSavePath(request) + folderName;
        // String fileUrl=System.getProperty("user.dir")+"\\dzcpt_service_provider\\src\\opencv_dll\\model\\";
        String fileUrl= FaStaticParam.PROJECT_PATH+"\\modelTemples\\model\\";
