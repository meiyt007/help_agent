...
import com.zfsoft.superwindow.util.Base64Util;
...
/*    public static void init(SysConfigParamProxy proxy) {
     ...
     * @date 2019年2月24日
     */
    public static AttaInfoResult uploadFileBase64(String originName, String userId, String base64) throws Exception {
     ...
     * @return 返回附件对象
     */
    public static AttaInfoResult getAttaInfo(String oid) throws Exception {
        Map<String, Object> param = new HashMap<>();
        param.put("oid", oid);
     ...
     * @throws Exception
     */
    public static AttaListResult getAttaList(String oids) throws Exception {
        Map<String, Object> param = new HashMap<>();
        param.put("oids", oids);
    ...
    public static AttaListResult getAttaList(List <String> oidList) throws Exception {
     ...
     * @date 2019年2月24日
     */
    public static AttaBase64Result getAttaBase64(String attaOid) throws Exception {
