var URL = 'js/plugins/zDialog/images/';	//附件上传路径，包含：图片、视频、音频、附件等文件
var IMAGESPATH = URL;
...
var Dialog = function (width, height, title) {
	...
	if(!this.ID)
      ...
      this.ID = Dialog._dialogArray.length + "";
    }
...
Dialog.prototype.create = function () {
  ...
  if(this.borderFlag) {
      ...
      <td width="8" height="23" style="background-color:#f3f6f9;border-radius:0 4px 0 0 ;"><div style="width: 8px;"><a id="_forTab_{thisID}" href="#;"></a></div></td>\
    </tr>';
  	} else {
    ...
    html += '</tr><tr>'
    	if(this.borderFlag) {
	    html += '<td height="8" style="background-color: #f3f6f9;border-radius:0 0 0 4px;"></td>\
	      <td style="background-color: #f3f6f9;"></td>\
	      <td height="8" style="background-color: #f3f6f9;border-radius:0 0 4px 0;"><a onfocus=\'$id("_forTab_{thisID}").focus();\' href="#;"></a></td>'
    	} else {
    		html += '<td height="9"></td>\
...
Dialog.alert = function (msg, func, w, h, drag) {
    ...
    diag.InnerHtml = '<table height="100%" width="90%" border="0" align="center" cellpadding="10" cellspacing="0">\
    	<tr><td align="center" style="padding:10px 0"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH+'icon_query.png" style="width:37px;height:37px;" align="absmiddle"></td></tr>\
...
Dialog.errorAlert = function (msg, func, w, h, drag) {
    var w = w || 360,
        h = h || 130;
    var diag = new Dialog({
        Width: w,
    ...
    diag.InnerHtml = '<table height="100%" width="90%" border="0" align="center" cellpadding="10" cellspacing="0">\
    	<tr><td align="center" style="padding:10px 0"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH+'icon_warn.png" style="width:37px;height:37px;" align="absmiddle"></td></tr>\
		<tr><td align="center" style="font-size:17px; color:#333;padding:0 20px 65px;font-family: 微软雅黑" id="Message_' + this.ID + '">' + msg + '</td></tr>\
	</table>';
    diag.show();
    diag.okButton.parentNode.style.textAlign = "center";
