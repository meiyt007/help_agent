...
(function () {
    ...
    var Flowchart = function (params) {
        ...
        var segments,
            ...
            midpoint = params.midpoint == null ? 0.2 : params.midpoint,
        ...
        this._compute = function (paintInfo, params) {
            ...
            //连接线折点位置，默认为连接线中间折线，修改为固定点，在连接线左边的20位置
            var midx = paintInfo.startStubX + 20;	//((paintInfo.endStubX - paintInfo.startStubX) * midpoint),
            //var midy = paintInfo.startStubY + 20;	//((paintInfo.endStubY - paintInfo.startStubY) * midpoint);
            var midy = ((paintInfo.endStubY - paintInfo.startStubY) * 0.5);
