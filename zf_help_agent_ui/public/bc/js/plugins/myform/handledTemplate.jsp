	...
	function viewSelect(formName, oid) {
		...
		diag.callBack = function(data) {
			$("input:text").each(function() {
				var cName = this.name.substring(columnName.length,this.name.length+1);
		...
		end85889093
		 <!-- 拼接form -->
			...
			<div class="memberData">
				...
				end85889093
					<li role="end85889093">
					<a role="tab" data-toggle="tab">end85889093</a>
					</li>
					end85889093
				</ul>
				end85889093
				...
				end85889093
					<div role="tabpanel" class="tab-pane" id="end85889093">
					end85889093
					</div>
					end85889093
				</div>
