...
var POBrowser = {
	...
	getRootPath: function () {
		...
		var index = pathName.indexOf("/js/plugins/pageoffice4/pageoffice.js");
		return pathName.substr(0, index) + '/pageoffice4';
	},
...
$(function () {
	$("body").append("<div class=\"pobmodal-overlay\"><div id=\"pobmodal-dialog\"></div></div>");
