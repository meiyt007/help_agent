...
export function intelligentPretrialmaterialPrePrial(caseOid,caseFileRecOid,caseMaterialOid,cataOid) {
  return request({
    url: process.env.VUE_APP_ZC_INDUSTRY_ROUTE_PATH + '/industryPreTrial/intelligentPretrialmaterialPrePrial',
    params: {
      caseOid: caseOid,
...
export function intelligentPretrial(caseOid) {
  return request({
    url: process.env.VUE_APP_ZC_INDUSTRY_ROUTE_PATH + '/industryPreTrial/intelligentPretrial',
    params: {
      pacCaseOid: caseOid,
    },
    method: 'get'
...
export function viewResult(caseOid,caseFileRecOid,caseMaterialOid,cataOid) {
  return request({
    url: process.env.VUE_APP_ZC_INDUSTRY_ROUTE_PATH + '/industryPreTrial/viewResult',
    params: {
      caseOid: caseOid,
      caseFileRecOid:caseFileRecOid,
      caseMaterialOid:caseMaterialOid,
