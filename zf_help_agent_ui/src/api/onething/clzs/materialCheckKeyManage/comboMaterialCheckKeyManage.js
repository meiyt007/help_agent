...
//保存/更新样表信息
export function saveOrUpdateComboAhsSamplePicInfo(data) {
  return request({
    url: process.env.VUE_APP_ZC_ONETHING_ROUTE_PATH + '/comboExaminePointCarding/saveOrUpdateComboAhsSamplePicInfo',
    method: 'post',
    data: data,
    headers:{
      "Content-Type":"application/json;charset=UTF-8",
...
//根据样表信息查询列表
export function getComboAhsSamplePicInfoList(data) {
  return request({
    url: process.env.VUE_APP_ZC_ONETHING_ROUTE_PATH + '/comboExaminePointCarding/getComboAhsSamplePicInfoList',
    headers:{
      "Content-Type":"application/json;charset=UTF-8",
    },
    method: 'post',
...
// 删除样表信息
export function deleteComboAhsSamplePicInfo(id) {
  return request({
    url: process.env.VUE_APP_ZC_ONETHING_ROUTE_PATH + '/comboExaminePointCarding/deleteComboAhsSamplePicInfo',
    params: {
      id: id
    },
    method: 'post'
...
export function querySysAttaListByMaterialOid(materialOid,caseOid) {
  return request({
    url: process.env.VUE_APP_ZC_ONETHING_ROUTE_PATH +'/comboExaminePointCarding/querySysAttaListByMaterialOid/',
    params: {
...
//根据材料获取一件事附件
export function queryComboAttaListByMaterialOid(materialOid,comboDireOid) {
  return request({
