...
export function saveOptionService(serviceOid,valOid, comboDireOid){
  return request({
    url: process.env.VUE_APP_THING_ROUTE_PATH +'/combo/optionService/saveOptionService?serviceOid='+serviceOid+'&valOid='+valOid + '&comboDireOid='+comboDireOid,
    method: 'get'
  })
}
