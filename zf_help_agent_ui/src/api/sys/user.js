...
export function getHonorList () {
  return request({
    url: process.env.VUE_APP_ZC_ROUTE_PATH + '/honor/honorList',
    method: 'get'
  })
}
...
export function getPersonalHonors () {
  return request({
    url: process.env.VUE_APP_ZC_ROUTE_PATH + '/honor/getPersonalHonors',
    method: 'get'
  })
}

// 获取个人荣誉
export function getOneHonorList (userOid) {
  return request({
    url: process.env.VUE_APP_ZC_ROUTE_PATH + '/honor/getOneHonorList?userOid=' + userOid,
    method: 'get'
  })
}

// 赋予荣誉
export function saveOrUpdateWorkerHonor (data) {
  return request({
    url: process.env.VUE_APP_ZC_ROUTE_PATH + '/honor/saveOrUpdateWorkerHonor',
    method: 'post',
    data: data
  })
}
