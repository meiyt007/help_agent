...
export function handleInitMater(id,serviceOid) {
  return request({
    url: process.env.VUE_APP_DSXBL_ROUTE_PATH +'/single/SxMaterialElmsConfig/init?materialOid='+id+'&serviceOid='+serviceOid,
    method: 'get'
  })
}
// 初始化结果与证照目录配置页面
...
export function saveOrUpdate(data) {
  return request({
    url: process.env.VUE_APP_DSXBL_ROUTE_PATH + '/single/SxMaterialElmsConfig/save',
    method: 'post',
    headers:{
      "Content-Type":"application/json;charset=UTF-8",
    },
