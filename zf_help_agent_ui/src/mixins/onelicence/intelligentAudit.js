...
import {getIndustryCaseMaterialListAndAuditResult,industryViewDetailResult} from '@/api/onelicence/industryManager/industryCaseAccept/materialClassifiler.js'
import ZfImageLoading from "@/components/ZfImageLoading";

import IntelligentAuditDetail from '@/views/onelicence/industryManager/industryCaseAccept/components/intelligentAuditDetail';
...
export default {
  ...
  methods: {
    ...
    getMaterialPrePrialNew () {
      ...
      getIndustryCaseMaterialListAndAuditResult({ caseOid: this.caseOid, comboDireOid: this.comboDirectoryOid })
