<template>
  <div class="process-box">
    ...
    <!-- 第二步 -->
    <div class="step-content step-second" v-if="show">
      ...
      <div class="data-box">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="data-table">
          ...
          <tr>
            <td>1</td>
            <td>融资担保公司的设立申请变更登记表.doc</td>
            <td>原件</td>
            <td>电子档</td>
            <td>1</td>
            <td><span class="bage-necessery">必要</span></td>
          </tr>
          <tr>
            <td>2</td>
            <td>融资担保公司的设立申请变更登记表.doc</td>
      ...
      <div class="btn-wrap">
        <el-radio v-model="radio" label="1"
          >我已核验上述材料并确定齐全</el-radio
        >
        <div class="btn-list mt10">
          <el-button type="primary" icon="el-icon-circle-check"
            >下一步</el-button
          >
          <el-button type="info" icon="el-icon-video-pause" class="print-btn"
            >打印一次性告知单</el-button
          >
        </div>
      </div>
    ...
    <!-- 第三步 -->
    <div class="step-content step-third" v-if="show">
      <div class="step-third-box">
        ...
        >
          ...
          >
            ...
            <tr>
              <td><i class="require">*</i><b>申请人姓名：</b></td>
              <td>
                <el-form-item prop="name">
                  <el-col :span="24">
                    <el-input v-model="ruleForm.name"></el-input>
                ...
                <el-form-item prop="region">
                  <el-col :span="24">
                    ...
                    >
                      ...
                      <el-option label="退伍军人" value="beijing"></el-option>
                    </el-select>
                  </el-col>
                </el-form-item>
              </td>
            ...
            <tr>
              <td><i class="require">*</i><b>联系人手机：</b></td>
              <td>
                <el-form-item prop="name">
                  <el-col :span="24">
                    <el-input v-model="ruleForm.name"></el-input>
      ...
      <div class="step-third-box">
        ...
        >
          ...
          >
            ...
            <tr>
              <td><i class="require">*</i><b>填写表单：</b></td>
              <td colspan="3">
                <el-row :gutter="10">
                  <el-col :span="12">
                    ...
                    <div class="form-box-inline">
                      ...
                      <div class="form-btn-group">
                        <el-button icon="el-icon-view" class="btn"
                          >表单预览</el-button
                        >
                        <el-button icon="el-icon-edit-outline" class="btn"
                          >表单修改</el-button
                        >
                      </div>
                      <ul>
    ...
    <!-- 第四步 -->
    <div class="step-content step-fourth" v-if="show">
      <h3 class="title"><i class="el-icon-s-grid"></i>申请者相关信息</h3>
      <el-form
        label-width="0px"
        class="demo-ruleForm"
      ...
      >
              ...
              <div class="handle-data">
                ...
                <ul>
                  <li>
                    <el-row :gutter="24">
                      <el-col :span="5">
                        <a href="##" class="grid-content qdcg-success">
                          <img
                      ...
                      <el-col :span="14">
                        <div class="grid-content qdcg-text">
                          <img
                            src="../../assets/image/icons05.png"
                            alt=""
                            srcset=""
                          />
                          <p>
                            融资担保公司的设立融资担保公司的设立材料.doxc<span
                              >2.5M</span
                            >
                          </p>
                        </div>
                  ...
                  <li>
                    <el-row :gutter="24">
                      <el-col :span="5">
                        <a href="##" class="grid-content qdcg-fail">
                          <img
                  ...
                  <li>
                    <el-row :gutter="24">
                      <el-col :span="19">
                        <div class="grid-content qdcg-text">
                          <img
                            src="../../assets/image/icons08.png"
                            alt=""
                            srcset=""
                          />
                          <p>企业营业资格证书.JPG<span>2.5M</span></p>
                        </div>
                      </el-col>
                      <el-col :span="5">
                        <div class="grid-content qdcg-btn">
                      ...
                      <el-col :span="19">
                        <div class="grid-content qdcg-text">
                          <img
                            ...
                            srcset=""
                          />
                          <p>融资担保公司的设立材料.JPG<span>2.5M</span></p>
                        </div>
                      </el-col>
                      <el-col :span="5">
                        <div class="grid-content qdcg-btn">
        ...
        <div class="btn-wrap">
          <div class="btn-list mt10">
            <el-button type="primary" icon="el-icon-back">下一步</el-button>
            <el-button type="info" icon="el-icon-video-pause" class="print-btn"
              >跳过</el-button
            >
    ...
    <!-- 第五步 -->
    <div class="step-content step-last" v-if="show">
      <h3 class="title"><i class="el-icon-s-grid"></i>申请者相关信息</h3>
      <el-form
        :model="ruleForm"
        :rules="rules"
      ...
      >
        ...
        >
          ...
          <tr>
            ...
            <td><b>是否受理：</b></td>
            <td>
              <el-radio v-model="radio" label="1">受理通过</el-radio>
              <el-radio v-model="radio" label="2">不予受理</el-radio>
            </td>
          </tr>
          <tr>
            <td><b>文本域：</b></td>
        ...
        <div class="btn-wrap">
          <div class="btn-list mt10">
            <el-button type="primary" icon="el-icon-back">下一步</el-button>
            <el-button type="primary" icon="el-icon-video-pause"
              >受理</el-button
            >
          </div>
        </div>
