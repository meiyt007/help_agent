  ...
  <div class="app-container" style="height:auto">
    ...
    >
      <el-form-item label="组名" prop="groupName">
        <el-col :span="24">
          <el-select v-model.trim="queryParams.groupId" placeholder="请选择">
            <el-option
    ...
    >
      ...
      >
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="zf-zc-table">
          ...
          <tr>
            <td><i class="require">*</i><b>小组名</b></td>
            <td>
            ...
            <td>
              <el-form-item prop="groupName">
                <el-select v-model.trim="form.groupName" placeholder="请选择" @change="formPadding;$forceUpdate();">
                  <el-option
...
import {
  ...
  page,
  saveOrUpdateGroup
} from "@/api/ha/groupSplitManagement/groupSplitManagement.js";
import {queryWorkGroupTree} from "@/api/ha/userManagement/userManagement";

export default {
  name: "groupSplitManagement",
  props: {
    groupId: {
      type: String,
      default: () => '',
  ...
  watch: {
    keyValue(val) {
      ...
      this.queryParams.groupName = this.groupName;
      this.getList();
    }
  },
  created() {
  ...
  methods: {
    ...
    //表单填充，一个单选框填充两个form属性
    formPadding(index) {
      // console.log(this.groupIdOptions[index].id);
      this.form.groupId = this.groupIdOptions[index].id;
      this.form.groupName = this.groupIdOptions[index].name;
      // this.$set(this.form,"groupId",event.groupId);
      // this.$set(this.form,"groupName",event.groupName);
