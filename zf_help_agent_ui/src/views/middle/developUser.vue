<template>
  <div class="app-container typeApp">
    ...
    <el-row :gutter="10" class="mb8 fl">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleInit"
          v-hasPermi="['im:developUser:save']"
        >新增</el-button
        >
      </el-col>
    </el-row>
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['im:developUser:view']"
          >查看</el-button
          >
          <el-button
            size="mini"
            ...
            v-hasPermi="['im:developUser:update']"
          >修改</el-button
          >
          <el-button
            size="mini"
            ...
            v-hasPermi="['im:developUser:delete']"
          >删除</el-button
          >
          <el-button
            size="mini"
            ...
            v-hasPermi="['im:developUser:audit']"
          >审核</el-button
          >
        </template>
      </el-table-column>
    ...
    <el-dialog
      ...
      append-to-body
    >
      <div class="zf-zc-table--title">开发商用户基本信息</div>
      <table
        cellspacing="0"
        cellpadding="0"
        border="0"
...
import {rules} from "../onething/comboManager/comboAccept/components/constant";
export default {
  components: {},
  name: "DevelopUser",
  data () {
