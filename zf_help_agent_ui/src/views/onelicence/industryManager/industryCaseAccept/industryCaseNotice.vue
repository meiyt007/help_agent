    ...
    <div class="process-box">
      ...
      <div class="step-content step-second" v-if="show_1">
        <div class="situation-box">
          ...
          >
            <div id="print">
              <h3 class="mt30" style="font-size: 12px">
                <i class="el-icon-s-grid"></i
              ...
              >
                ...
                <!--              <tr style="line-height: 1.15;">-->
                <!--                <td style=" padding: 17px 10px; font-size: 12px; color: #515a6e; text-align: right;"><b>情形选项：</b></td>-->
                <!--                <td colspan="3" style=" font-size: 12px; color: #515a6e; ">-->
                <!--                  <div v-for="data in serviceTitleValList">-->
              ...
              <h2 class="mt30" style="font-size: 12px">
                <i class="el-icon-s-grid"></i>所需材料列表
              </h2>
              <table
                cellspacing="0"
                cellpadding="0"
                border="0"
                class="el-table__body table2"
                style="border-collapse: collapse; border: 1px solid #dfe6ec"
                v-if="
    ...
    getSituationOpinionTitle (optionTitles) {
      if (optionTitles) {
        optionTitles.forEach(optionTitle => {
          ...
          if (optionTitle.comboOptionVals != null && optionTitle.comboOptionVals != "") {
            optionTitle.comboOptionVals.forEach(data => {
              if (data.ifCheck == true) {
                //放入选中的标题和选项值
                let titlevalueset = {};
                titlevalueset.titleName = optionTitle.name;
                titlevalueset.valueName = data.name;
                titlevalueset.titleOid = optionTitle.titleOid;
                this.serviceTitleValList.push(titlevalueset);
              }
            });
          }
...
.step-second .table2 tr td {
  background-color: #fff !important;
}
.step-second .table2 tr th {
  background-color: #f8f8f9;
}
</style>
