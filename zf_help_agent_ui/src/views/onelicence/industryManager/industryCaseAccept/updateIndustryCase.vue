  ...
  <div class="app-container">
    ...
    <div class="process-box" id="print">
      <div class="step-title">
        <span v-for="(item, index) in stepData" :key="item.index" :class="{ active: index == i }">
          {{ item.title }}
        </span>
      </div>
      <!-- 第一步 -->
      <div class="step-content step-first" v-if="show_0">
        <div class="situation-box">
          ...
          <div class="select-list">
            <span v-for="(item, index) in selectData" :key="item.index"
              :class="{ current: index == num }">{{ item.situationName }}</span>
          </div>
        </div>
        ...
        <el-form :model="optionForm" :rules="rules" ref="optionForm" label-width="0px" class="demo-optionForm"
          :label-position="labelPosition">
          <table cellspacing="0" cellpadding="0" border="0" class="el-table__body mt20">
            <colgroup>
              <col width="15%" />
            </colgroup>
            <tr>
                  ...
                  <div v-for="(data,index) in direSituationOptionTitles">
                    <div class="check-list">
                      ...
                      <!--<el-radio-group v-model="checkList[index]">
                        <el-radio v-for="item in data.comboOptionVals" :label="item.valOid" >{{ item.name }}</el-radio>
                      </el-radio-group>-->
                    </div>
                  </div>
                </div>
      ...
      <div class="step-content step-second" v-if="show_1">
        <el-form :model="comboDireForm" ref="comboDireForm" label-width="0px" class="demo-comboDireForm"
          :label-position="labelPosition">
        ...
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="0px" class="demo-ruleForm"
              ...
              <tr>
                ...
                <td colspan="3">
                  <el-form-item prop="applyUserName">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.applyUserName" name="applyUserName" maxlength="50" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr>
                ...
                <td>
                  <el-form-item prop="credentialType">
                    <el-col :span="24">
                      <el-select v-model="ruleForm.credentialType" placeholder="请选择证件类型" @change="changeType">
                        <el-option v-for="certificateType in certificateTypeList" :key="certificateType.dictOid"
                          :label="certificateType.name" :value="certificateType.dictOid">
                        </el-option>
                      </el-select>
                    </el-col>
                  </el-form-item>
                ...
                <td>
                  <el-form-item prop="credentialNumber">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.credentialNumber" name="credentialNumber" maxlength="20"
              ...
              <tr>
                ...
                <td>
                  <el-form-item prop="applyUserPhone">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.applyUserPhone" name="applyUserPhone" maxlength="11" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
                ...
                <td>
                  <el-form-item prop="applyUserTel">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.applyUserTel" name="applyUserTel" maxlength="13" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr v-if="cegisterType==0">
                ...
                <td colspan="3">
                  <el-form-item prop="applyUserAddress">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.applyUserAddress" name="applyUserAddress" maxlength="100"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr v-else>
                ...
                <td colspan="3">
                  <el-form-item prop="legalPersonName">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.legalPersonName" name="legalPersonName" maxlength="50"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr>
                ...
                <td colspan="3">
                  <el-form-item prop="projectName">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.projectName" name="projectName" maxlength="100" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr>
                ...
                <td>
                  <el-form-item prop="bussVenueDistrictOid">
                    <el-col :span="24">
                      <treeselect :multiple="true" :options="districtOptions" :flat="true" :default-expand-level="1"
                        placeholder="请选择业务管辖地" v-model="ruleForm.bussVenueDistrictOid" append-to-body />
                    </el-col>
                  </el-form-item>
                </td>
                ...
                <td>
                  <el-form-item prop="specificLocation">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.specificLocation" name="specificLocation" maxlength="200"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr>
                ...
                <td>
                  <el-form-item prop="investProjecName">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.investProjecName" name="investProjecName" maxlength="200"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
                ...
                <td>
                  <el-form-item prop="investProjectCode">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.investProjectCode" name="investProjectCode" maxlength="50"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr>
                ...
                <td colspan="3">
                  <el-form-item prop="projectAbstract">
                    <el-col :span="24">
                      <el-input type="textarea" v-model="ruleForm.projectAbstract" name="projectAbstract"
              ...
              <tr>
                ...
                <td>
                  <el-form-item prop="applyPostCode">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.applyPostCode" name="applyPostCode" maxlength="6" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
                ...
                <td>
                  <el-radio-group v-model="ruleForm.proxyFlag" @change="changeProxyFlag">
              ...
              <tr>
                ...
                <td colspan="3">
                  <el-form-item prop="contactUserName">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.contactUserName" name="contactUserName" maxlength="50"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr>
                ...
                <td>
                  <el-form-item prop="contactCredentialNumber">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.contactCredentialNumber" name="contactCredentialNumber" maxlength="18"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
                ...
                <td>
                  <el-form-item prop="contactEmail">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.contactEmail" name="contactEmail" maxlength="25" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr>
                ...
                <td>
                  <el-form-item prop="contactUserPhone">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.contactUserPhone" name="contactUserPhone" maxlength="11"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
                ...
                <td>
                  <el-form-item prop="contactUserTel">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.contactUserTel" name="contactUserTel" maxlength="13" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr>
                ...
                <td colspan="3">
                  <el-form-item prop="contactRemark">
                    <el-col :span="24">
                      <el-input type="textarea" v-model="ruleForm.contactRemark" name="contactRemark" maxlength="500"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
          ...
          <div class="step-third-box">
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="el-table__body">
              ...
              <tr>
                ...
                <td colspan="3">
                  <el-radio-group v-model="ruleForm.resultDeliveryWay" @change="changeDeliveryWay">
              ...
              <tr v-if="address_show">
                ...
                <td>
                  <el-form-item prop="addresseeName" style="float:left;margin-bottom:2px;width:80%">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.addresseeName" name="addresseeName" maxlength="50" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                ...
                <td>
                  <el-form-item prop="addresseePostCode">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.addresseePostCode" name="addresseePostCode" maxlength="6"
                        show-word-limit></el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr v-if="address_show">
                ...
                <td>
                  <el-form-item prop="addresseePhone">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.addresseePhone" name="addresseePhone" maxlength="11" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
                ...
                <td>
                  <el-form-item prop="addresseeTel">
                    <el-col :span="24">
                      <el-input v-model="ruleForm.addresseeTel" name="addresseeTel" maxlength="13" show-word-limit>
                      </el-input>
                    </el-col>
                  </el-form-item>
                </td>
              ...
              <tr v-if="address_show">
                ...
                <td>
                  <el-form-item prop="addresseeAddress">
                    <el-col :span="24">
                      <el-cascader size="large" :options="provinceCityOptions" v-model="ruleForm.addresseeAddress">
                      </el-cascader>
                    </el-col>
                  </el-form-item>
                </td>
                ...
                <td>
                  <el-form-item prop="addresseeDetailAddress">
                    <el-col :span="24">
                      <el-input v-model.trim="ruleForm.addresseeDetailAddress" name="addresseeDetailAddress"
          ...
          <div class="step-third-box" v-if="formConfig_show">
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="el-table__body">
              ...
              <tr>
                ...
                <td colspan="3">
                  <el-row :gutter="10">
                    <el-col :span="12" class="mb10" v-for="(dataForm,i) in sxSerFormList">
                      <div class="form-box-inline">
                        <h4>1、{{dataForm.formName}}</h4>
                        <div class="form-btn-group" v-if="tempFormDataId[i]">
                          <el-button icon="el-icon-view" class="btn" @click="viewFormFilling(caseForm[i],i)">表单预览
                          </el-button>
                          <el-button icon="el-icon-edit-outline" class="btn" @click="formFilling(dataForm,i)">表单修改
                          </el-button>
                        </div>
                        <el-button type="primary" icon="el-icon-edit-outline" v-if="!tempFormDataId[i]"
                          class="btn-write" @click="formFilling(dataForm,i)">填写表单</el-button>
                        <ul>
                          <li>
                            ...
                            <div class="input-text">
                              <h4>表单编码：</h4>
                              <p v-if="dataForm.formCode" :title="dataForm.formCode">{{dataForm.formCode}}</p>
                          ...
                          <li>
                            ...
                            <div class="input-text">
                              <h4>表单说明：</h4>
                              <p v-if="dataForm.formText" :title="dataForm.formText">{{dataForm.formText}}</p>
                          ...
                          <li>
                            ...
                            <div class="input-text">
                              <h4>表单样本：</h4>
                              <p v-if="dataForm.simpleAtta" :title="dataForm.attaName">{{dataForm.attaName}}<span style="cursor: pointer;"
                                  @click="downloadFile(dataForm.simpleAtta)">下载 </span></p>
          ...
          <div class="btn-wrap">
            <div class="btn-list mt10">
              ...
              <el-button type="info" icon="el-icon-video-pause" class="print-btn" @click="checkPbpjInfo('')">暂存
              </el-button>
      ...
      <div class="step-content step-fourth" v-if="show_3">
        <el-button type="primary"  @click="clfl()" class="data-btn2">材料分类</el-button>
        <el-button type="primary" :loading="false" @click="clzs(4,1)" class="data-btn">材料智审</el-button>
        <h3 class="title"><i class="el-icon-s-grid"></i>申请者相关信息</h3>
        <el-form ref="materialForm" :model="materialForm" :rules="rules" label-width="0px" class="demo-materialForm"
          :label-position="labelPosition">
          <table cellspacing="0" cellpadding="0" border="0" class="data-table" ref="materialTable">
            <colgroup>
              <col width="5%" />
              <col width="31%" />
              <col width="15%" />
            ...
            <tbody v-for="(item,index) in industryCaseMaterials">
              <tr>
                ...
                <td>
                  <el-radio label="1" v-model="radio1[item.caseMaterialOid]"
                    @change="chooseCollectionType('1',item,item.caseMaterialOid)">纸质收取</el-radio>
                  <el-radio label="2" v-model="radio1[item.caseMaterialOid]"
                    @change="chooseCollectionType('2',item,item.caseMaterialOid)">附件上传</el-radio>
                  <el-radio label="3" v-model="radio1[item.caseMaterialOid]"
                    @change="chooseCollectionType('3',item,item.caseMaterialOid)">扫描</el-radio>
                  <el-radio label="5" v-model="radio1[item.caseMaterialOid]"
                    @change="chooseCollectionType('5',item,item.caseMaterialOid)">证照库</el-radio>
                  <el-radio label="4" v-if="dishonestFlag && item.comboDireMaterial.mustFlag==2" v-model="radio1[item.caseMaterialOid]"
                    @change="chooseCollectionType('4',item,item.caseMaterialOid)">容缺后补</el-radio>
                </td>
              </tr>
                ...
                <td colspan="5">
                  <div class="handle-data">
                    <el-row class="right-btn-group">
                      <el-button type="primary" @click="openMaterialComparison(item)" icon="el-icon-document"
                        size="mini">材料比对</el-button>
                    </el-row>
                    <el-row class="right-btn-group-two">
                      <el-form ref="formForm" :model="formData" :rules="rules" size="medium" label-width="100px">
                        <el-form-item>
                          <el-upload class="upload-demo" action="" multiple :limit="5" :data="item"
                            :http-request="uploadFiles" :before-upload="beforeUpload" :on-error="uploadError"
                            :show-file-list="showFileList" accept="accept">
                        ...
                        <el-row :gutter="24">
                          <el-col :span="9">
                            <div class="grid-content qdcg-text">
                              ...
                              <p :title="data.originName">{{data.originName}}</p>
                            </div>
                          </el-col>
                          <el-col :span="5">
                            <span v-for="catalog in item.materialCatalogList">
                              <el-radio :label="catalog.materialCatalogOid" v-model="data.materialCatalogOid"
                                @change="chooseCatalog(item.caseMaterialOid,data.oid,catalog.materialCatalogOid)">{{ catalog.catalogName }}
                              </el-radio>
                            </span>
                          </el-col>
                          <el-col :span="5">
                            <div class="grid-content qdcg-btn">
                              <el-button type="text" icon="el-icon-view" @click="viewFile(data.oid)"></el-button>
                              <el-button type="text" icon="el-icon-delete" @click="deleteFile(item,data)"></el-button>
                            </div>
                          </el-col>
                        </el-row>
                      </li>
                    ...
                    <el-row class="right-btn-group-two">
                      <el-form ref="formForm" :model="formData" :rules="rules" size="medium" label-width="100px">
                        <el-button size="mini" type="primary" icon="el-icon-upload"
                          @click="scanPicture(item.caseMaterialOid,item.oid,item)">点击扫描</el-button>
                      </el-form>
                    </el-row>
                    <ul v-for="data in item.attaList">
                      <li>
                        <el-row :gutter="24">
                          ...
                          <el-col :span="5" v-if="data.extensionName &&(data.extensionName.indexOf('png')>-1||data.extensionName.indexOf('jpg')>-1)">
                            <div class="grid-content qdcg-btn">
                              <el-button type="text" icon="el-icon-view" @click="viewFile(data.oid)"></el-button>
                              <el-button type="text" icon="el-icon-delete" @click="deleteFile(item,data)"></el-button>
                            </div>
              ...
              <tr v-show="show_elem[item.caseMaterialOid]">
                <td colspan="5">
                  <div class="handle-data">
                    <el-row class="right-btn-group-two">
                      <el-button v-if="item.sourceType==1" size="mini" type="primary" icon="el-icon-upload"
                                 @click="getElecLicenInfo(item.caseMaterialOid,item.materialOid,'',index)">获取证照</el-button>
                      <el-button v-if="item.sourceType==0" size="mini" type="primary" icon="el-icon-upload"
                                 @click="getElecLicenInfo(item.caseMaterialOid,item.materialOid,item.comboDireMaterial.elecBillOid,index)">获取证照</el-button>
                    </el-row>
                    <ul v-for="data in attaList[index]">
                      <li>
                        <el-row :gutter="24">
                          ...
                          <el-col :span="5">
                            <div class="grid-content qdcg-btn">
                              <el-button type="text" icon="el-icon-view" @click="viewElemsInfo(data.attaOid)">
                              </el-button>
                            </div>
                          </el-col>
                        </el-row>
              ...
              <tr>
                ...
                <td colspan="3">
                  <el-form-item prop="rqhbTime">
                    <el-date-picker v-model="materialForm.rqhbTime" type="date" value-format="yyyy-MM-dd"
                      :picker-options="pickerrqhbTime" placeholder="选择到期时间">
                    </el-date-picker>
                  </el-form-item>
                </td>
              </tr>
      ...
      <div class="step-content step-last" v-if="show_4">
        <h3 class="title"><i class="el-icon-s-grid"></i>申请者相关信息</h3>
        <el-form :model="acceptForm" :rules="rules" ref="acceptForm" label-width="0px" class="demo-acceptForm"
          :label-position="labelPosition">
          <table cellspacing="0" cellpadding="0" border="0" class="el-table__body">
            <colgroup>
              <col width="15%" />
            ...
            <tr>
              ...
              <td colspan="3">
                <el-form-item prop="acceptOpinionDesc">
                  <el-col :span="24">
                    <el-input type="textarea" v-model="acceptForm.acceptOpinionDesc" name="acceptOpinionDesc"
                              maxlength="200"
                              show-word-limit></el-input>
                  </el-col>
                </el-form-item>
          ...
          <div class="btn-wrap">
            <div class="btn-list mt10">
              ...
              <el-button type="primary" icon="el-icon-video-pause" @click="pushPjCaseService">受理</el-button>
              <el-button type="primary" icon="el-icon-video-pause"  v-if="flagCc" @click="qlCaseCharge">
                收费</el-button>
              <el-button type="primary" icon="el-icon-video-pause"  v-if="chakanCharge" @click="viewCharge">
                查看缴费</el-button>
            </div>
          </div>
        </el-form>
      ...
      <!--表单嵌套页面-->
      <el-dialog title="电子表单" :visible.sync="iframeState" width="80%" height="100%" v-if="iframeState"
        :modal-append-to-body="true" append-to-body>
        <iframe-url :outLink="iframeUrl" @closeIframe="closeIframe"></iframe-url>
      </el-dialog>

      <el-dialog title="电子表单预览" :visible.sync="iframVieweState" width="80%" v-if="iframVieweState"
        :modal-append-to-body="true" append-to-body height="100%">
        <iframe-url-view :outLink="iframeUrlView" @closeIframeView="closeIframeView"></iframe-url-view>
      </el-dialog>
    </div>
    <!--</el-dialog>-->
    <!--引入文件的预览弹出层-->
    <el-dialog v-dialog-drag title="文件预览" :visible.sync="view.show" v-for="view in viewDialogOptions" width="60%"
      append-to-body>
      <industry-case-file-view :attaOid="view.attaOid" @father-click="closeFileView"></industry-case-file-view>
    </el-dialog>


    <el-dialog v-dialog-drag :visible.sync="item.show" v-for="item in materialComparisonOptions" @close="outerVisible"
      :title="item.title" width="80%" height="700px" append-to-body>
      ...
      <el-scrollbar style="height:650px;">
        <industry-material-comparison :sampleInfoOid="item.sampleInfoOid" :comboDirectoryOid="item.comboDirectoryOid"
          :materiaOid="item.materiaOid" :caseOid="item.caseOid" :caseMaterialOid="item.caseMaterialOid"
          :attaOids="item.attaOids" :attaLists="item.attaLists" :fileViewurl="item.fileViewurl" :title="item.title"
    ...
    <!--业态智审结果-->
    <el-dialog v-dialog-drag :visible.sync="item.show" v-for="item in comboIntelligentPretrialOptions" :title="item.title" width="50%" append-to-body>
      <el-scrollbar style="height:500px;">
        <industry-intelligent-pretrial :caseOid="item.caseOid" :caseMaterialOid="item.caseMaterialOid"
          :caseFileRecOid="item.caseFileRecOid" :cataOid="item.cataOid" :title="item.title"></industry-intelligent-pretrial>
      </el-scrollbar>
    </el-dialog>


     <!--    材料分类-->
    <el-dialog v-dialog-drag :visible.sync="item.show" v-for="item in materialClassifilerOptions" :title="item.title"  width="80%" append-to-body>
      <el-scrollbar style="height:500px;">
        <material-classifiler :caseOid="item.caseOid" :classifierId="item.classifierId"
                              :title="item.title"  @father-click="closeChild" ></material-classifiler>
      </el-scrollbar>
    </el-dialog>

    <!-- 获取收费信息-->
    <el-dialog v-dialog-drag :visible.sync="chargeShow" v-if="chargeShow" title="办件收费" width="60%" append-to-body>
      <case-charge @case-close="closeCaseCharge"></case-charge>
    </el-dialog>

    <!-- 获取收费信息-->
    <el-dialog v-dialog-drag :visible.sync="viewchargeShow" v-if="viewchargeShow" title="查看收费信息" width="60%" append-to-body>
...
import {
  delFile
} from "@/api/onelicence/industryManager/industryCaseAccept/industryCaseAtta";
import {
  validatePhone,
  validateTel,
  validateAddresseeTel,
  validateApplyUserTel,
  validIDCard,
  validatePostCode,
  validateEmails,
  validUnifiedCredit
...
import {
  ...
  viewResult
} from "@/api/onelicence/industryManager/industryCaseAccept/industryIntelligentPretrial";
import industryIntelligentPretrial from '@/views/onelicence/clzs/directoryManagement/industryIntelligentPretrial';
import {
  regionData
...
import {pbpjSaveCaseInfo, pushPbpjInfo,getloginUser} from "@/api/onelicence/industryManager/industryCaseAccept/initIndustryCase";
...
import materialClassifiler from '@/views/onelicence/industryManager/industryCaseAccept/materialClassifiler';
...
export default {
  ...
  name: "updateCaseInfo",
  //定义获取父类传过来值的格式
  props: ["industryCaseOid", "comboDireOid"],
  data() {
    return {
      ...
      rules: {
        ...
        applyUserTel: [{
          ...
          {
            validator: validateApplyUserTel,
            trigger: 'blur'
          }
        ],
        credentialType: [{
        ...
        addresseeTel: [{
          validator: validateAddresseeTel,
          trigger: 'blur'
        }],
        addresseeAddress: [{
          required: true,
      ...
      pickerrqhbTime: {
        disabledDate: time => {
          const beginDateVal = new Date((new Date() - 24 * 60 * 60 * 1000)).getTime()
          if (beginDateVal) {
  ...
  methods: {
    //关闭材料分类，并且把材料分类数据带到上传附件页面
    closeChild(obj){
      let _that = this;
      //材料分类带来的材料数据
      let wffcaseMaterials=JSON.parse(obj);
      //console.log("wffcaseMaterial长度***"+wffcaseMaterials.length())
     /* console.log("wffcaseMaterials"+"**wffcaseMaterials="+JSON.stringify(wffcaseMaterials));
      console.log("industryCaseMaterials"+"**industryCaseMaterials="+JSON.stringify(_that.industryCaseMaterials));*/
      //循环原材料把分类带来的材料根据材料id信息放入对应的位置
      _that.industryCaseMaterials.forEach(industryCaseMaterial=>{
        let caseMaterialOid=industryCaseMaterial.caseMaterialOid;
          wffcaseMaterials.forEach(wffindustryCaseMaterial=>{
            let wffCaseMaterialOid=wffindustryCaseMaterial.caseMaterialOid;
            if(caseMaterialOid==wffCaseMaterialOid){
              let industryClassifyRecList=wffindustryCaseMaterial.industryClassifyRecList;
               if(null!=industryClassifyRecList&&industryClassifyRecList.length>0){
                 console.log("qqq"+wffindustryCaseMaterial.materialName);
                 //添加有材料的上传方式选择
                 _that.chooseCollectionTypeNew('2',industryCaseMaterial,caseMaterialOid);
                 industryClassifyRecList.forEach(classifyRec=>{
                   let industryCaseAtta=classifyRec.industryCaseAtta;
                   //把材料添加到显示的列中
                   industryCaseMaterial.attaList.push(industryCaseAtta);
                   let at = new Object();
                   at.caseMaterialOid = caseMaterialOid;
                   at.attaOid = industryCaseAtta.oid;
      ...
      this.materialClassifilerOptions.pop();
    },
    //弹出材料分类页面
    clfl(){
      let _that = this;
      let caseOid=_that.industryCaseOid;
      //console.log(JSON.stringify(this.comboDireForm))
      let classifierId=_that.comboDireForm.classifierId;
      let item = {
        caseOid: caseOid,
      ...
      _that.materialClassifilerOptions.push(item);

    },
    //分类的材料添加
    chooseCollectionTypeNew(val, item, index) {
      let bb = new Object();
      ...
      if (this.collectionTypeList.length > 0) {
        let count = this.collectionTypeList.findIndex(da => {
          if (item.caseMaterialOid === da.caseMaterialOid) {
      ...
      this.radio1[index]='2';
      /*console.log("this.radio1"+JSON.stringify(this.radio1))*/
    },
    ...
    next(index, count) {
      if (count > 0) {
        ...
        if (index == 4) {
          ...
          // this.show_4 = true;
          this.catalogList = [];
          this.checkInDishonestUser(index);
        }
      } else {
        this.i = index;
        if (index == 0) {
              ...
              this.sxSerFormList.forEach((items, i) => {
                tempForm.forEach((childItem, j) => {
                  if (childItem.serFormOid == items.oid) {
                    this.$set(this.caseForm,i,childItem);
                    this.$set(this.tempFormDataId,i,childItem.formDataId);
                  }
                })
              })
            }
    ...
    getIndustryCaseSituationList() {
      let _that = this;
      //查询事项情形
      getCaseSituationList(_that.industryCaseOid).then(response => {
        // this.situationName = "默认自定情形";
        let situation = response.data.comboSituations;
        if (situation) {
          _that.comboDireSituationOid = situation.oid;

          _that.getSituationOpinion(situation);
        }
        ...
        _that.comboDireOid = response.data.industryCase.comboDireOid;
        _that.cegisterType = response.data.industryCase.applyUserType;
        //获取证照类型
        _that.getSelectCertificateType();
        //获取一件事目录信息
        _that.comboDireForm = response.data.comboDirectory;
        _that.ruleForm = response.data.industryCase;
        //初始化证件号码是否验证
        _that.changeType(_that.ruleForm.credentialType);
        //获取一件事材料
        _that.comboDireMaterials = response.data.directoryMaterials;
        //办件信息
        _that.id = response.data.industryCase.id;
        _that.industryCaseOid = response.data.industryCase.caseOid;
        _that.caseNumber = response.data.industryCase.caseNumber;
        _that.caseStatus = response.data.industryCase.caseStatus;
        _that.materialForm.rqhbTime = response.data.industryCase.rqhbTime;
        //办件材料信息
        _that.industryCaseMaterials = response.data.industryCase.industryCaseMaterials;
        if (_that.industryCaseMaterials) {
          _that.$nextTick(() => {
            _that.materialAttaList = [];
            _that.industryCaseMaterials.forEach(mat => {
              let bb = new Object();
              bb.collectionType = mat.collectionType;
              bb.caseMaterialOid = mat.caseMaterialOid;
              bb.collectionNumber = mat.collectionNumber;
              bb.materialName = mat.materialName;
              bb.mustFlag = mat.mustFlag;
              bb.attaOid = mat.attaList;
              _that.collectionTypeList.push(bb);
              if(mat.collectionType =="5" && mat.collectionFlag ==1
                 && mat.elemLicenseOid !=null && mat.elemNumber !=null ){
                let at = new Object();
                at.caseMaterialOid = mat.caseMaterialOid;
                at.attaOid = mat.elemLicenseOid;
                _that.materialAttaList.push(at);
              }
              mat.attaList.forEach(att => {
                ...
                if(att.materialCatalogOid){
                  _that.chooseCatalog(mat.caseMaterialOid,att.oid,att.materialCatalogOid)
                }
              });
              ...
              //拼接材料目录
              _that.comboDireMaterials.forEach((ml,z)=>{
                  if(ml.materialOid==mat.materialOid){
                    mat.comboDireMaterial=ml;
                  }
              })
            });
          });
        }
        _that.addresseeAddressOids = response.data.industryCase.addresseeAddress;
        _that.bussVenueDistrictOids = response.data.industryCase.bussVenueDistrictOid;
        _that.changeDeliveryWay(response.data.industryCase.resultDeliveryWay);
        _that.changeProxyFlag(response.data.industryCase.proxyFlag);
        _that.getDistrictTree("", response.data.industryCase.bussVenueDistrictOid);
        _that.getAddressTree(response.data.industryCase.addresseeAddress);
      });
    },
    /** 填充选项 */
    ...
    checkPbpjInfo(index) {
      ...
      _that.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          ...
          //业务管辖地
          if (typeof this.ruleForm.bussVenueDistrictOid != "string") {
            let districtOid = [];
            let oids = "";
            districtOid = this.ruleForm.bussVenueDistrictOid;
      ...
      pushPbpjUser(_that.loginUser.userOid).then(response => {
        ...
        if (response.data != "") {
          if (response.data.confirmFlag == "1") {
            ...
            _that.saveIndustryCaseForm(index);
          }
        }
      });
    },
        ...
        if (response.data) {
          //检查平板评价登录
           _that.$confirm('你确定要进行办件信息确认吗？', "警告", {
            ...
            regIndustryCaseInfo(ruleForm, _that.pbpjCaseOkUrl).then(response => {
              if (response.data) {
    ...
    getDataCheckValue(num, index) {
      let _that = this;
      industryCaseCallBack().then(response => {
        if (response.data == "1") {
          //保存办件
    ...
    saveIndustryCaseForm(index) {
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          ...
          this.ruleForm.caseOid = this.industryCaseOid;
          ...
          saveIndustryCase(this.ruleForm).then(response => {
            if (response.data != "") {
              this.industryCaseOid = response.data.caseOid;
      ...
      if (this.industryCaseMaterials) {
        this.$nextTick(() => {
          this.industryCaseMaterials.forEach((ma,j) => {
    ...
    checkInDishonestUser(index) {
      ...
      if (_that.rqhbMaterialList.length > 0) {
        this.$refs["materialForm"].validate((valid) => {
          if (valid) {
            checkApplyUserInDishonest(this.ruleForm.applyUserName, this.ruleForm.credentialNumber).then(
              response => {
                if (response.data != null) {
                  this.msgError("申请人为失信人，请重新选择材料上传方式！");
                  return false;
                } else {
    ...
    saveMaterialAtta(index) {
      ...
      if (_that.collectionTypeList.length > 0) {
        let mustFlag = false;
        let mustName = "";
        this.collectionTypeList.forEach(must => {
          if (must.mustFlag == 1 && must.collectionType == null) {
            mustFlag = true;
            mustName = must.materialName;
            return false;
          }
        });
        if (mustFlag == true) {
          _that.msgError(mustName + "的收取方式未选择");
          return false;
        }
        //遍历收取类型
        for (let j = 0; j < _that.collectionTypeList.length; j++) {
          const type = _that.collectionTypeList[j];
          if (type.collectionType == 2 || type.collectionType == 3 || type.collectionType == 5) {
            //附件上传、扫描、电子证照
            if (_that.materialAttaList.length > 0) {
              ...
              for (let k = 0; k < _that.materialAttaList.length; k++) {
                ...
                if (type.caseMaterialOid == atta.caseMaterialOid) {
                  mustAttaFlag = true;
                }
              }
              //必须材料附件，未收取
              if (mustAttaFlag == false) {
                _that.msgError(type.materialName + "的附件未上传！");
                return false;
              }
            } else {
              _that.msgError("必选材料的附件未上传！");
              return false;
            }
          }
        }
        ...
        /********************************************/
        let dataForm = {};
        dataForm.caseOid = _that.industryCaseOid;
        ...
        if(_that.materialCatalogAttaList&&_that.materialCatalogAttaList.length>0){
          _that.materialCatalogAttaList.forEach((fire,j)=>{
            if(fire){
              tempMaterialCatalogAtta.push(fire);
            }
          })
          tempMaterialCatalogAtta.forEach((fir,i)=>{
            tempMaterialCatalogAtta.forEach(second=>{
          ...
          if (_that.rqhbMaterialList.length > 0) {
            _that.$confirm('你确定要打印容缺补正承诺书吗？', "警告", {
              ...
              POBrowser.openWindowModeless(process.env.VUE_APP_BASE_API_PAGE +
                '/manage/zhuozheng/printComboCaseRqhbNotice?rqhbTime=' + dataForm.rqhbTime + '&sqrName=' +
    ...
    clzs(index, count) {
      ...
      if (this.collectionTypeList) {
        let mustFlag = false;
        let mustName = "";
        _that.collectionTypeList.forEach(must => {
          if (must.mustFlag == 1 && must.collectionType == null) {
            mustFlag = true;
            mustName = must.materialName;
            return false;
        ...
        const loadingnew = _that.$loading({
          lock: true,
          text: '材料审核中...',
        ...
        if (_that.materialCatalogAttaList.length <= 0) {
          loadingnew.close();
      ...
      pushPbpjCheckLogin().then(response => {
        if (response.data) {
          ...
          _that.$confirm('你确定要进行办件评价吗？', "警告", {
            ...
            pbpjSaveCaseInfo(_that.industryCaseOid).then(response => {
              if (response.data != null) {
                 let caseNumber = response.data
                  pushPbpjInfo(caseNumber).then(response => {
                    if (response.data != null) {
                      _that.$emit('view-case');
                    }
                  });
              } else {
    ...
    caseAccpet(flag) {
      let _that = this;
      if (_that.industryCaseOid != "") {
        _that.acceptForm.caseOid = _that.industryCaseOid;
        _that.acceptForm.caseNumber = _that.ruleForm.caseNumber;
        _that.acceptForm.sqrName = _that.ruleForm.applyUserName;
        _that.acceptForm.sqTime = _that.ruleForm.createDate ? _that.ruleForm.createDate.substring(0, 10) : _that.ruleForm.createDate;
        ...
        if (_that.acceptForm.ifAccept == 1) {
          ...
          _that.$confirm('您是否要打印不予受理通知书？', "警告", {
            confirmButtonText: "确定",
            cancelButtonText: "取消",
            type: "warning"
          }).then(function () {
            POBrowser.openWindowModeless(process.env.VUE_APP_BASE_API_PAGE +
              '/manage/zhuozheng/printComboCaseNotAcceptNotice?caseNumber=' + _that.acceptForm.caseNumber +
    ...
    chooseCollectionType(val, item, index) {
     ...
     // if (val == "1") {
        if (this.materialAttaList) {
          ...
          this.industryCaseMaterials.forEach(caseMaterial => {
            if (caseMaterial.caseMaterialOid == item.caseMaterialOid) {
                caseMaterial.attaList = [];
            }
          });
    ...
    /** 检查失信人 */
    checkDishonestUser(index){
      let _that = this;
      checkApplyUserInDishonest(this.ruleForm.applyUserName, this.ruleForm.credentialNumber).then(response => {
        if(response.data != null){
      ...
      delFile(bean.caseMaterialOid, atta.oid).then(response => {
        if (response.data != "") {
          ...
          if(this.materialCatalogAttaList && this.materialCatalogAttaList.length>0){
            this.materialCatalogAttaList.forEach((cata,i)=>{
              if(cata){
                if(cata.caseMaterialOid==bean.caseMaterialOid){
                  this.materialCatalogAttaList.splice(i,1,{});
                }
              }
    ...
    scanPicture(caseMaterialOid, index, item) {
      ...
      let caseOid = this.industryCaseOid;
    ...
    formFilling(dataForm, index) {
      ...
      if (dataForm) {
        ...
        } else if (dataForm.formType == 1) { //电子表单
    ...
    saveCaseForm() {
      ...
      if (_that.sxSerFormList) {
        _that.sxSerFormList.forEach((items, i) => {
          ...
          formData.industryCaseOid = _that.industryCaseOid;
    ...
    getElecLicenInfo(caseMaterialOid, materialOid,billOid, index) {
      ...
      let userName = "";
      let idCard = "";
      //billOid ="2c287adb7839b78101783e13bcaf000a";
      ...
      if (userName && idCard) {
        queryElecLicenseByDirCode(materialOid, userName, idCard,billOid).then(response => {
          if (response.data) {
            ...
            let at = new Object();
            at.caseMaterialOid = caseMaterialOid;
            at.attaOid = response.data.elecLicenOid;
            _that.materialAttaList.push(at);
            //判断elemLicenseList是否已经存在办件的证照信息
