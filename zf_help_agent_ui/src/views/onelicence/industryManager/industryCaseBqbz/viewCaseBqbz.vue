...
<script>
import {saveOrUpdate,getCorrectMaterialInfo,getIndustryCaseByOid,getOneByid} from "@/api/onelicence/industryManager/industryCaseAccept/industryCaseBqbz";
...
export default {
  ...
  methods: {
    ...
    getIndustryCaseByOid(this.caseOid).then(response => {
                 ...
                 //this.getApplyInfo();
                 this.material = response.data.industryCaseMaterials;
                 //this.getSdfs();
                 })
