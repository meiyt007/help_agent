...
<template>
  <div class="app-container">
          ...
          <el-table-column label="操作" align="center" width="400" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              <el-button size="mini" type="text" icon="iconfont zfsoft-chakan" @click="handleView(scope.row)"
                v-hasPermi="['sys:comboDone:view']">查看</el-button>
              <el-button size="mini" type="text" icon="iconfont zfsoft-xiugai" @click="handlePrint(scope.row)"
                v-hasPermi="['sys:comboDone:view']">补打收件回执</el-button>
              <el-button size="mini" v-if="clzsFlag" type="text" icon="iconfont zfsoft-chakan"
                @click="handlePreviewIntelligent(scope.row)" v-hasPermi="['sys:comboDone:view']">查看智审</el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <!-- 打印回执单 -->
    <el-dialog v-dialog-drag :close-on-click-modal="false" :title="dialogTitle" v-if="addDialogShow"
      :visible.sync="addDialogShow" width="1100px" height="700px" scrollbar append-to-body center>
      <div id="print">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="zf-zc-table">
          ...
          <tr>
            <td><b>目录名称：</b></td>
            <td colspan="3">{{printCaseInfo.comboDirectory.comboDirectoryName}}</td>
          </tr>
          <tr>
            <td><b>所属区划：</b></td>
          ...
          <tr>
            <td><b>办件编号：</b></td>
            <td>{{ printCaseInfo.industryCase.caseNumber}}</td>
            <td><b>受理时间：</b></td>
            <td>{{printCaseInfo.industryCase.acceptanceDate}}</td>
          </tr>
          <!-- <tr>
               <td><b>受理人：</b></td>
               <td><el-form-item prop="slPerson"><el-col :span="24">{{ printCaseInfo.slPerson}}</el-col></el-form-item></td>
               <td><b>受理网点：</b></td>
               <td><el-form-item prop="slInternet"><el-col :span="24">{{printCaseInfo.slInternet}}</el-col></el-form-item></td>
             </tr>-->
          <tr>
            <td v-if="printCaseInfo.applyUserType=='0'"><b>申请人名称：</b></td>
            <td v-else><b>申请单位名称：</b></td>
            <td>{{printCaseInfo.industryCase.applyUserName}}</td>
            <td v-if="printCaseInfo.applyUserType=='0'"><b>申请人手机：</b></td>
            <td v-else><b>申请单位手机：</b></td>
            <td>{{printCaseInfo.industryCase.applyUserPhone}}</td>
          </tr>
          <tr>
            <td><b>领取方式：</b></td>
            <td colspan="3">
              <span v-if="printCaseInfo.industryCase.resultDeliveryWay==1">
                快递送达
              </span>
              <span v-if="printCaseInfo.industryCase.resultDeliveryWay==2">
                自行取件
              </span>
              <span v-if="printCaseInfo.industryCase.resultDeliveryWay==3">
                其他
              </span>
            </td>
          </tr>
          <tr>
            <td><b>受理具体地点：</b></td>
            <td colspan="3">{{ printCaseInfo.industryCase.specificLocation}}</td>
          </tr>
          <tr>
            <td><b>材料名称：</b></td>
          ...
          <tr>
            <td style="text-align: center">
              <vue-qr :text="printCaseInfo.industryCase.caseNumber" :size="93"></vue-qr>
              <div>办件编号</div>
            </td>
            <td colspan="3">
              签名：
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="zf-zc-table">
          ...
          <tr>
            ...
            <td>{{ printCaseInfo.industryCase.caseNumber}}</td>
            <td><b>申请时间：</b></td>
            <td>{{printCaseInfo.industryCase.createDate}}</td>
          </tr>
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="zf-zc-table">
          ...
          <tr>
            <td colspan="5" style="text-align: center"><b>材料证照流转签字表</b></td>
          </tr>
          <tr>
            <td style="text-align: center;background-color:#fff"><b>类型</b></td>
            <td style="text-align: center"><b>环节</b></td>
            <td style="text-align: center;background-color:#fff"><b>签字单位/人</b></td>
            <td style="text-align: center"><b>签字</b></td>
            <td style="text-align: center;background-color:#fff"><b>时间</b></td>
          </tr>

          <tr>
            <td rowspan="2" style="text-align: center;background-color:#fff"><b>材料</b></td>
            <td style="text-align: center;background-color:#fff"><b>窗口出库</b></td>
            <td style="text-align: center;background-color:#fff"><b>收件（受理）人</b></td>
            <td style="text-align: center;background-color:#fff"><b></b></td>
            <td style="text-align: center;background-color:#fff"><b></b></td>
          </tr>
          <tr>
            <td style="text-align: center;background-color:#fff"><b>部门签收</b></td>
            <td style="text-align: center;background-color:#fff"><b>业务部门</b></td>
            <td style="text-align: center;background-color:#fff"><b></b></td>
            <td style="text-align: center;background-color:#fff"><b></b></td>
          </tr>
          <tr>
            <td rowspan="2" style="text-align: center;background-color:#fff"><b>证照</b></td>
            <td style="text-align: center;background-color:#fff"><b>部门签收</b></td>
            <td style="text-align: center;background-color:#fff"><b>业务部门</b></td>
            <td style="text-align: center;background-color:#fff"><b></b></td>
            <td style="text-align: center;background-color:#fff"><b></b></td>
          ...
          <tr>
            <td style="text-align: center;background-color:#fff"><b>窗口签收</b></td>
            <td style="text-align: center;background-color:#fff"><b>出件人</b></td>
            <td style="text-align: center;background-color:#fff"><b></b></td>
            <td style="text-align: center;background-color:#fff"><b></b></td>
          </tr>
        </table>
    ...
    <!-- 办件详细信息 -->
    <el-dialog v-dialog-drag :visible.sync="openView" v-if="openView" :title="title" width="1100px" height='700px'
...
<script>
  ...
  } from "@/api/onelicence/industryManager/industryCaseDone/industryCaseDone";
