...
import {intelligentPretrial,viewResult} from "@/api/onething/comboManager/comboAccept/comboIntelligentPretrial";
export default {
  ...
  methods: {
   ...
   /*   console.log(JSON.stringify(row))*/
      let caseOid=this.caseOid;
      let caseMaterialOid=row.comboCaseMaterial.caseMaterialOid;
