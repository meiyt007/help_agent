          ...
          <template v-if="ruleForm.delFlag === 0">
            <tr>
              ...
              <td>
                <el-form-item
                  :prop="
                    'faModelRuleValidationList.' + index + '.typeLabelTree'
                  "
                  :rules="rules.typeLabelTree"
                >
                  <el-tooltip
                    effect="dark"
                    :content="
                  ...
                  >
                    <el-cascader
                      :ref="`cascader1-${index}`"
                      v-model="ruleForm.typeLabelTree"
...
<script>
import { queryMaterialElementTreeSelect, queryFaModelRuleValidationList, saveOrUpdateFaModelRuleValidation, queryMaterialAndCataAndElementTree } from "@/api/onething/clzs/modelManagement/comboFaModelRuleValidation";
