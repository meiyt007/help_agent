...
<template>
  <div class="package-model-points-manage">
    <table
      cellspacing="0"
      cellpadding="0"
      border="0"
...
<script>
import { initComboFaModelRule, initAll, getComboFaModelRuleValidationList, saveOrUpdate } from "@/api/onething/clzs/modelManagement/comboFaModelRuleValidation";
...
export default {
  ...
  methods: {
    ...
    initInfo () {
      this.loading = true;
      getComboFaModelRuleValidationList(this.queryParams).then(response => {
