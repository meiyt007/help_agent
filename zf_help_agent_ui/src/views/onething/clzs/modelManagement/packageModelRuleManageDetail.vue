        ...
        <tr v-for="(materialCatalog, indexx) in item.materialCatalogList">
          ...
          <td>
            <div class="add-box">
              <span
                :title="
                  materialCatalog.catalogName + materialCatalog.catalogCode
                "
              >
              ...
              >
                <li>
                  <span :title="faModelTemplateBlock.blockName">
...
import { initComboFaModelRule, initAll } from "@/api/onething/clzs/modelManagement/comboFaModelRuleValidation.js";
export default {
  props: ['comboDirectoryOid', 'comboDirectoryCode', 'themeName', 'comboDirectoryName'],
  data () {
    return {
      num: 0,
      // 遮罩层
