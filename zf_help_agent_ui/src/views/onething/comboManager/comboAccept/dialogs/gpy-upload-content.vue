    ...
    <el-scrollbar class="gpy-upload-content--body">
      ...
      >
        <transition-group name="upload" tag="div" class="gpy-upload-content--list">
          <div class="gpy-upload-content--item" v-for="(item, index) in uploadList" :key="item.attaOid">
            <div class="gpy-upload-content--item-img" @click="handlePreview(`zfImage-${index}`, $event)">
              ...
              <img
                ...
                class="gpy-upload-content--item-img-delete"
...
export default {
  ...
  computed: {
    uploadNum ({ folder: { hasUploadPage, total, isRefinedMaterialFolder } }) {
      return {
