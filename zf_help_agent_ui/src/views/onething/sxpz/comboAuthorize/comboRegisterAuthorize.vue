...
import { getOneForAuthorize, saveOrUpdateForRegister, getComboOne, delComboDireReg } from "@/api/onething/comboAuthorize/comboAuthorize";
import comboDirectoryView from "@/views/onething/sxpz/comboDirectory/comboDirectoryView";
export default {
  name: "ComboRegisterAuthorize",
