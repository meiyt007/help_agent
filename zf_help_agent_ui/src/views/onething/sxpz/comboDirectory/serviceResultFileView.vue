...
<script>
  import { getSxSysAttaByOid,getPdf } from "@/api/onething/sxpz/serviceResultAtta";
  import pdf from 'vue-pdf'
  export default {
    components: {
      pdf
    },
    name: "serviceResultFileView",
    props:["attaOid"],
    data() {
      return {
        flag:true,
    ...
    methods: {
      ...
      preview(ty,name,fileUrl) {
        ...
        if(1 === ty){
          ...
          this.fastFlag ='0';
          this.fileUrl = process.env.VUE_APP_BASE_API_PAGE + "/combo/atta/downloadResultFile/"+ fileUrl;
        }
