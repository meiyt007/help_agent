/* * @Description: 一件事告知单管理 * @Author: dxl **/
...
<template>
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        <el-form :model="queryParams" ref="queryForm" :inline="true">
          <el-form-item label="所属目录" prop="comboDirectoryOid">
            <el-select v-model="queryParams.comboDirectoryOid" filterable placeholder="请选择所属目录" size="small"
    ...
    <el-dialog v-dialog-drag :visible.sync="openView" v-if="openView" :close-on-click-modal="false" :title="title"
      ...
      <el-scrollbar style="max-height:calc(100vh - 330px);overflow: scroll;">
  ...
  export default {
    ...
    methods: {
      ...
      getComboDirectoryList() {
        this.loading = true;
        queryAllDirectoryPublish().then(response => {
