...
import { queryFieldListInfo } from "@/api/onething/comboForm/fieldManage";
...
export default {
  ...
  methods: {
    ...
    querySxColumnByType () {
      ...
      const { contentOid, fieldTypeOid, typeOid, labelOid, formOid } = this.params;
      queryFieldListInfo(contentOid, typeOid || fieldTypeOid, labelOid, formOid).then(
        response => {
          if (response.code === 200) {
