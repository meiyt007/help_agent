          ...
          <tr>
            ...
            <td>
              <el-form-item>
                ...
                <span v-if="parentSysConfig.code">{{
                  parentSysConfig.code
                }}</span>
              </el-form-item>
            </td>
            <td><b>上级系统配置名称：</b></td>
            <td>
              <el-form-item>
                ...
                <span v-if="parentSysConfig.name">{{
                  parentSysConfig.name
                }}</span>
              </el-form-item>
            </td>
          </tr>
        ...
        if (valid) {
          save(this.form).then(response => {
            if (response.code === 200) {
              ...
              this.openInit = false;
              if (
                this.form.configOid == undefined ||
                null == this.form.configOid
              ) {
                //新增一个节点
