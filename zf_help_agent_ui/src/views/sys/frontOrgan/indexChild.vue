<!-- <template>
  <div class="app-container">
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="组织机构名称" align="center" prop="name" :show-overflow-tooltip="true"/>
      <el-table-column label="组织机构全称"  align="center" prop="fullName" :show-overflow-tooltip="true"/>
      <el-table-column label="组织机构代码"   align="center" prop="code" :show-overflow-tooltip="true"/>
      <el-table-column label="组织机构电话"   align="center" prop="telphone" />
      <el-table-column label="类型" align="center" prop="typeDictName" />
      ...
      <el-table-column label="操作" width="325"  align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            size="mini"
            type="text"
          ...
          <el-button
            ...
            @click="handleChildView(scope.row)"
            ...
            <tr>
              ...
              <td>
                <el-form-item prop="name">
                  <el-input v-model.trim="form.name" placeholder="请输入组织机构名称" maxlength="100" show-word-limit/>
                </el-form-item>
              </td>
              ...
              <td>
                <el-form-item prop="fullName">
                  <el-input v-model.trim="form.fullName" placeholder="请输入组织机构全称" maxlength="50" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-form-item prop="code">
                  <el-input v-model.trim="form.code" placeholder="请输入组织机构代码" maxlength="9" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-form-item prop="simpleCode">
                  <el-input v-model.trim="form.simpleCode" placeholder="请输入组织机构简码" maxlength="25" show-word-limit/>
                </el-form-item>
              </td>
              ...
              <td>
                <el-form-item prop="address">
                  <el-input v-model.trim="form.address" placeholder="请输入组织机构地址" maxlength="200" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-form-item prop="uniteCode">
                  <el-input v-model.trim="form.uniteCode" placeholder="请输入社会信用代码" maxlength="18" show-word-limit/>
                </el-form-item>
              </td>
              ...
              <td>
                <el-form-item  prop="telphone">
                  <el-input v-model.trim="form.telphone" placeholder="请输入组织机构电话" maxlength="13" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr>
    ...
    <el-dialog v-dialog-drag :visible.sync="openUserListView"  title="查看用户列表" @close="closeUserView" width="70%" height="500px"  scrollbar append-to-body>
        <index-user :organOid="userOrganOid"></index-user>
    </el-dialog>
  </div>
</template>
...
export default {
  name: "OrganInner",
  props: ['childParentOid','childDistrictName','childOrganName','childDistrictOid'],
  ...
  created() {
    this.queryParams.parentOid = this.childParentOid;
    this.queryParams.districtName = this.childDistrictName;
    this.queryParams.districtOid =  this.childDistrictOid;
  ...
  methods: {
    ...
    //查看用户
    handleUserList(row){
      this.openUserListView = true;
      this.userOrganOid = row.organOid;
    },
    // 关闭按钮
    closeUserView() {
      this.openUserListView = false;
    },
    //查看子机构(调用父类)
    handleChildView(row){
      // 将子组件与父组件联合起来
      this.$emit('father-click',row.name,row.organOid,row.districtName,row.districtOid);
    },
    /** 查看按钮操作 */
    handleView(row) {
      this.reset();
    ...
    handleInit(row) {
      this.reset();
      const oid = row.id;
      this.form.parentOid = this.childParentOid;
      this.form.parentName = this.childOrganName;
      this.form.districtName = this.childDistrictName;
      this.form.districtOid =  this.childDistrictOid;
      if(oid == undefined){
        this.openInit = true;
        this.title = "新增组织机构信息";
      }else {
