  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="消息状态">
        ...
        >
          <el-option
            v-for="(value, key) in readStatusMap"
            :key="key"
            :label="value"
            :value="key"
          />
    ...
    >
      ...
      <el-table :data="messageFileList" style="width: 100%">
        <el-table-column label="附件名称">
          <template slot-scope="scope">
            <span>{{ scope.row.name }}</span>
          </template>
        </el-table-column>
        <el-table-column label="附件大小" width="180">
          <template slot-scope="scope">
            <span>{{ scope.row.size }}</span>
          </template>
        </el-table-column>
