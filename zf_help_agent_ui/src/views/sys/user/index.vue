<template>
  <div class="app-container">
            ...
            <tr>
              ...
              <td colspan="3">
                <span
                  v-for="post in postList"
                  v-if="
                    undefined != form.postOids &&
                    form.postOids.indexOf(post.postOid) != -1
                  "
                >
                  {{ post.name }}&nbsp;&nbsp;
                </span>
    ...
    >
      <div
        v-bind:style="{ height: dialogHeight }"
      >
        <el-form
          ref="roleForm"
          :model="form"
