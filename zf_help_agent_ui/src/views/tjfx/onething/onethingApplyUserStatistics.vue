/**
* @Author: liangss
* @Date: 2021-04-21 14:25:16
* @Description: 一件事办事人统计
*/
<template>
...
<script>
import { getOnethingApplyUserStatistics, listExpOnethingApplyUserStatistics } from "@/api/tjfx/oneThingStatistics";
...
export default {
  name: "onethingApplyUserStatistics",
  ...
  methods: {
    ...
    getList () {
      this.loading = true;
      getOnethingApplyUserStatistics(this.queryParams).then(response => {
    ...
    handleExport () {
      ...
      this.$confirm('是否确认导出列表数据项?', "警告", {
        ...
        listExpOnethingApplyUserStatistics(queryParams);
      }).catch(function () { });
    }
