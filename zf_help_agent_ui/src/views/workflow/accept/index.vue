                ...
                <el-form-item prop="eventName" >
                  <el-col :span="24">
                    <el-radio-group v-model="processExample.eventName">
                      ...
                      <el-radio v-show="step && step.rejectTaskId && '' != step.rejectTaskId" label="驳回">驳回</el-radio>
                      <el-radio v-show="step && step.fallbackTaskId && '' != step.fallbackTaskId" label="退回">退回</el-radio>
                    </el-radio-group>
                  </el-col>
                </el-form-item>
              </td>
        ...
        getTaskCondition(row.taskId).then(response => {
          if (response.code === 200) {
            ...
            if(undefined!=this.step){
              this.processExample.rejectTaskId = undefined!=this.step.rejectTaskId?this.step.rejectTaskId:"";
              this.processExample.fallbackTaskId = undefined != this.step.fallbackTaskId ?this.step.fallbackTaskId:"";
            }
          }
        });
      },
