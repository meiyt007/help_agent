<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" border="">
      ...
      <el-table-column label="创建时间" align="center" prop="createDate" width="250">
        <!--<template slot-scope="scope">
      ...
      <el-table-column label="操作" width="250" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['workflow:type:delete']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  import { init, save, del ,getOne, page, able } from "@/api/workflow/type";
