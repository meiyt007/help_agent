      ...
      <el-container>
          ...
          <el-container>
            <el-aside width="500px">
              ...
              >
                ...
                ></el-table-column>
                <el-table-column
                  property="conditionalOptLabel"
                  label="判断条件"
                ></el-table-column>
                <el-table-column
                  property="conditionalVal"
                  label="值"
                ></el-table-column>
                <el-table-column
                  property="logicLabel"
              ...
              <div style="textalign: right">
                ...
                <el-button-group
                  style="margin-left: 5px; margin-right: 0px; margin-top: 8px"
                >
                  <el-button
                    type="primary"
                    icon="el-icon-minus"
        ...
        <el-footer style="textalign: right">
          <el-button type="primary" @click="dialogTableVisible = false"
            >取 消</el-button
          >
          <el-button type="primary" @click="saveConditions"
            >保存并关闭</el-button
          >
        </el-footer>
      </el-container>
