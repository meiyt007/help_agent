  ...
  >
    ...
    >
      ...
      <IntelligentPane
        ...
        :index="`${index+1}`"
        :total="total"
        :localAuditImageUrl="!item.localAuditImageUrl?'':item.localAuditImageUrl.indexOf('http')>-1?previewImageUrl+item.localAuditImageUrl:previewImageUrl+item.localAuditImageUrl"
        :materialSampleAddr="!item.materialSampleAddr?'':item.materialSampleAddr.indexOf('http')>-1?previewImageUrl+item.materialSampleAddr: previewImageUrl+item.materialSampleAddr"
...
import { confirmQlCaseMaterialt } from '@/api/materialCategory.js';
export default {
...
console.log("IntelligentPane=====",this.intelligentDetailList)
  ...
  methods: {
    ...
    handleConfirm () {
      confirmQlCaseMaterialt({ caseMaterialOid: this.$attrs.qlCaseMaterial?.caseMaterialOid })
