        ...
        <template>
          <div class="primary-table">
            ...
            <el-table :data="preTrialResultVoList" border style="width: 100%">
              ...
              <el-table-column label="审核名称" prop="name" width="350">
              </el-table-column>
              <el-table-column label="审核结果"  width="200">
                <template slot-scope="scope">
                  ...
                  <template v-if="scope.row.resultStatus=='4'||scope.row.resultStatus==4">
                    无需要审核的附件
                  </template>
                </template>
...
import {intelligentPretrial,intelligentPretrialmaterialPrePrial,viewResult} from "@/api/zc/businessManagement/temporaryAcceptance";
export default {
  ...
  methods: {
    ...
    getintelligentPretrialold(){
      //caseOid=4eb5b388851a4ce08341450529aaf5d1****caseFileRecOid=4c5442d707434e7790b344131dc48531&&&caseMaterialOid=31eaa7f0c96d4c73aa104c5d77868222
      //caseOid=4eb5b388851a4ce08341450529aaf5d1****caseFileRecOid=d7369539b9e54b35b7e1ff4ecaa7695c&&&caseMaterialOid=31eaa7f0c96d4c73aa104c5d77868222
      //caseOid=4eb5b388851a4ce08341450529aaf5d1****caseFileRecOid=fab111376bcf4b7980429102c1095c41&&&caseMaterialOid=31eaa7f0c96d4c73aa104c5d77868222
      // caseOid=4eb5b388851a4ce08341450529aaf5d1****caseFileRecOid=8d70f847900445038c283beeebc8f1ff&&&caseMaterialOid=31eaa7f0c96d4c73aa104c5d77868222
      /* let caseFileRecOid="8d70f847900445038c283beeebc8f1ff";
      let cataOid="4855f701ab774b02b7a79395efe1ab90";*/
      let caseOid="4eb5b388851a4ce08341450529aaf5d1";
      let caseMaterialOid="31eaa7f0c96d4c73aa104c5d77868222";
      let caseFileRecOid="d7369539b9e54b35b7e1ff4ecaa7695c";
      let cataOid=" 064539e108a24b0d97b81d6f7fe07844";
      ...
      intelligentPretrial(caseOid).then(response => {
        this.preTrialResultVoList=response.data.preTrialResultVoList;
        /* alert(this.preTrialResultVoList[0].name)
         alert(JSON.stringify(this.preTrialResultVoList[0]))*/
        /* console.log(JSON.stringify(this.preTrialResultVoList))*/
        /* console.log(JSON.stringify(this.preTrialResultVoList))*/
      })
    },
    ...
    handleView(row){
      let caseOid=this.caseOid;
      let caseMaterialOid=row.qlCaseMaterial.caseMaterialOid;
