      ...
      <el-col :span="24" :xs="24">
        ...
        >
          <el-form-item label="事项类型" prop="serviceTypeOidDict">
            <el-select
              v-model="queryParams.serviceTypeOidDict"
              placeholder="请选择事项类型"
...
import {
  ...
  saveOrUpdate,
  getTaocanList,
  saveOrUpdateAhsSamplePicInfo,
  getAhsSamplePicInfoList,
  deleteAhsSamplePicInfo
} from "@/api/zc/clzs/materialCheckKeyManage/materialCheckKeyManage.js";
