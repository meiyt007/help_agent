<template>
  ...
  <div class="app-container" @click="handleMessage">
    ...
    <span>消息列表</span>
    <i :class="infNumClass" v-show="numFlag" v-text="numberOfUnreadMessage">0</i>
    <el-dialog v-dialog-drag  v-show="false" :visible.sync="show"  title="查看消息列表"  @close="closeUserView" width="80%" append-to-body>
