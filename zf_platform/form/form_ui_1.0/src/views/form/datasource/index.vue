<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataSourceList" border>
      ...
      <el-table-column label="连接名" align="center" prop="connectionName" :show-overflow-tooltip="true" />
      <el-table-column label="数据库名" align="center" prop="datasourceName" :show-overflow-tooltip="true" />
          ...
          <table cellspacing="0" cellpadding="0" border="0" class="el-table__body">
            ...
            <td>
              <el-form-item prop="connectionName">
                <el-input v-model.trim="form.connectionName" placeholder="请输入连接名" maxlength="50" show-word-limit/>
              </el-form-item>
            </td>
              <td><i class="require">*</i><b>所属模块：</b></td>
              <td>
                <el-form-item prop="moduleOid">
                  <el-select v-model="form.moduleOid" filterable clearable placeholder="请选择">
                    <el-option
            ...
            <tr>
              ...
              <td>
                <el-form-item prop="type">
                  <el-select v-model="form.type" filterable clearable @change="typeChange" placeholder="请选择">
                    <el-option
              ...
              <td>
                <el-form-item prop="datasourceName">
                  <el-input v-model.trim="form.datasourceName" placeholder="请输入数据库名" maxlength="50" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <!--<tr>
            ...
            <tr>
              ...
              <td>
                <el-form-item prop="host">
                  <el-input v-model.trim="form.host" placeholder="请输入主机" maxlength="50" show-word-limit/>
                </el-form-item>
              </td>
              <td><i class="require">*</i><b>端口：</b></td>
              <td>
                <el-form-item prop="port">
                  <el-input v-model.trim="form.port" placeholder="请输入端口" maxlength="5" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-form-item prop="username">
                  <el-input v-model.trim="form.username" placeholder="请输入用户名" maxlength="40" show-word-limit/>
                </el-form-item>
              </td>
              <td><i class="require">*</i><b>密码：</b></td>
              <td>
                <el-form-item prop="password">
                  <el-input type="password" v-model.trim="form.password" placeholder="请输入密码" maxlength="40" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr v-if="form.type == 'oracle'">
              ...
              <td colspan="3">
                <el-form-item prop="serviceName">
                  <el-input v-model.trim="form.serviceName" placeholder="请输入服务名" maxlength="10" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="3">
                <el-form-item>
                  <el-button
                    type="primary"
                    size="mini"
                    @click="datasourceTest"
                  >测试连接</el-button>
                </el-form-item>
                <span v-if="tipInfo" style="color: #14d234; font-size: 14px;" >连接成功</span>
              </td>
            </tr>
          </table>
        </el-form>
    ...
    <!-- 查看信息详细 -->
    <el-dialog :title="title" :visible.sync="openView" width="70%" v-loading="fullscreenLoading" append-to-body>
      <div class="el-table__header-wrapper dialog-table">
        <!--<h3>事项标题</h3>-->
        <el-form :model="form" label-width="0px" class="demo-ruleForm">
          <table cellspacing="0" cellpadding="0" border="0" class="el-table__body">
            ...
            <tr>
              ...
              <td><b>类型：</b></td>
              <td>
                <span v-for="type in typeOptions" v-if="type.code == form.type">{{type.name}}</span>
              </td>
            </tr>
            <!--<tr>
              <td><b>驱动名称：</b></td>
...
<script>
  import { init, save, del ,getOne, page, able,checkConnection,getDataSourceDictList } from "@/api/form/dataSource";
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            if(null != this.form.password){
              this.form.EncryptPassword = encryptPwd(this.form.publicKey,this.form.password);
            }
