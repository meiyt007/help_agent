  ...
  <div class="app-container">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="表单设计" name="first">
        <Main v-if="show0" :authorizeKey="authorizeKey"></Main>
      </el-tab-pane>
      <el-tab-pane label="模块管理" name="second">
        <Module v-if="show1" :authorizeKey="authorizeKey"></Module>
      </el-tab-pane>
      <el-tab-pane label="数据源管理" name="third">
        <Datasource v-if="show2" :authorizeKey="authorizeKey"></Datasource>
      </el-tab-pane>
      <el-tab-pane label="存储对象" name="fourth">
        <Object v-if="show3" :authorizeKey="authorizeKey"></Object>
      </el-tab-pane>
      <el-tab-pane label="填报管理" name="five">
        <Report v-if="show4" :authorizeKey="authorizeKey"></Report>
      </el-tab-pane>
<!--&lt;!&ndash;      <el-tab-pane v-if="null==userOid || ''==userOid || undefined == userOid" label="成员管理" name="seven">&ndash;&gt;-->
<!--      <el-tab-pane v-if="undefined != getToken()" label="成员管理" name="seven">-->
<!--        <Member v-if="show5" :authorizeKey="authorizeKey"></Member>-->
<!--      </el-tab-pane>-->
    </el-tabs>
  </div>
</template>
<script>
  ...
  export default {
    ...
    created() {
      this.authorizeKey = this.$route.query.authorizeKey;
      this.show0 = true;
    },
    methods: {
