<template>
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24" class="app-right">
        ...
        <el-table  v-loading="loading" :data="dictList" border>
          ...
          <el-table-column label="字典代码" width="180"  align="center" prop="code" :show-overflow-tooltip="true"/>
          ...
          <el-table-column label="启用状态"  width="100"  prop="isAble"  align="center">
            <template slot-scope="scope">
              <el-switch
    ...
    <!-- 添加或修改数字字典信息对话框 -->
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="openInit" width="70%" append-to-body  class="el-dialog-type">
            ...
            <tr>
              ...
              <td>
                <el-form-item prop="name">
                  <el-input v-model.trim="form.name" placeholder="请输入字典名称" maxlength="50" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-form-item prop="code">
                  <el-input v-model.trim="form.code" placeholder="请输入字典代码" maxlength="25" show-word-limit/>
                </el-form-item>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <el-form-item prop="memo">
                  <el-input v-model.trim="form.memo" type="textarea" maxlength="500" show-word-limit placeholder="请输入备注"></el-input>
                </el-form-item>
              </td>
            </tr>
          </table>
...
<script>
import { init, save, del ,getOne, page, able,listExp,queryDictTree } from "@/api/sys/dict";
...
export default {
  ...
  methods: {
    ...
    getDictTree(parentOid) {
      queryDictTree(parentOid).then(response => {
