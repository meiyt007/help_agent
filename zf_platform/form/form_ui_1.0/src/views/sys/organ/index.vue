<template>
  <div class="app-container">
    ...
    <el-table  v-loading="loading"
      ...
      <el-table-column label="组织机构类别" align="center" prop="typeDictName" />
      ...
      <el-table-column label="操作" width="325" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            @click="handleChildView(scope.row.name,scope.row.organOid,scope.row.districtName,scope.row.districtOid)"
            ...
            <tr>
              ...
              <td>
                <el-form-item prop="districtOidSelect">
                  <treeselect  class="treeselect240" :defaultExpandLevel="1" noOptionsText = "暂无数据"  noResultsText="暂无数据" :show-count="true" v-model="form.districtOidSelect" :options="districtOptions" placeholder="请输入所属区划" />
                </el-form-item>
              </td>
            </tr>
            <tr>
    ...
    <el-dialog v-dialog-drag :visible.sync="item.show" v-for="item in dialogOptions" @close="outerVisible"
               :title="item.title" width="90%" append-to-body>
      <el-scrollbar style="height:500px;">
        <index-child :childParentOid="item.parentOid" :childOrganName="item.title" :childDistrictOid="item.districtOid" :childDistrictName="item.districtName" @father-click="handleChildView" ></index-child>
      </el-scrollbar>
    </el-dialog>
