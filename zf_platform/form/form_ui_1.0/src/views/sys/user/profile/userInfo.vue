        ...
        <tr>
          ...
          <td>
            <el-form-item prop="name">
              <el-input v-model="user.name" placeholder="请输入用户姓名" maxlength="50" show-word-limit/>
            </el-form-item>
          </td>
        ...
        <tr>
          ...
          <td>
            <el-form-item prop="position">
              <el-input v-model="user.position" placeholder="请输入职务" maxlength="50" show-word-limit/>
            </el-form-item>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <el-form-item prop="cardNo">
              <el-input v-model="user.cardNo" placeholder="请输入身份证号" maxlength="18" show-word-limit/>
            </el-form-item>
          </td>
          ...
          <td>
            <el-form-item prop="email">
              <el-input v-model="user.email" placeholder="请输入邮箱" maxlength="100" show-word-limit/>
            </el-form-item>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <el-form-item prop="mobile">
              <el-input v-model="user.mobile" placeholder="请输入手机" maxlength="11" show-word-limit/>
            </el-form-item>
          </td>
          ...
          <td>
            <el-form-item prop="telphone">
              <el-input v-model="user.telphone" placeholder="请输入座机" maxlength="13" show-word-limit/>
            </el-form-item>
          </td>
        </tr>
        <!--<tr>
