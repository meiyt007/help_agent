...
public class ThreadLocalAwareStrategy extends HystrixConcurrencyStrategy {
    ...
    public <T> Callable<T> wrapCallable(Callable<T> callable) {
        return existingConcurrencyStrategy != null
                ? existingConcurrencyStrategy.wrapCallable(new DelegatingUserContextCallable<T>(callable, CurrentLoginUserHolder.getCurrentLoginUser())) : super.wrapCallable(new DelegatingUserContextCallable<T>(callable, CurrentLoginUserHolder.getCurrentLoginUser()));
    }
