...
/**
 * @author: kkfan
 * @create: 2022-03-18 09:45:45
 * @description: 断言 断言失败返回{@link ResultInfoException } 简化判断
 */
public abstract class Assert {

	/**
	 * Assert a boolean expression, throwing an {@code ResultInfoException}
	 * if the expression evaluates to {@code false}.
	 * <p>Call {@link #isTrue} if you wish to throw an {@code ResultInfoException}
	 * on an assertion failure.
	 * <pre class="code">Assert.state(id == null, "The id property must not already be initialized");</pre>
	 * @param expression a boolean expression
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if {@code expression} is {@code false}
	 */
	...
	public static void state(boolean expression, Supplier<String> messageSupplier) {
		if (!expression) {
			throw new ResultInfoException(nullSafeGet(messageSupplier));
		}
	}
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the object is not {@code null}
	 */
	 ...
	 * @param object the object to check
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the object is {@code null}
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the text is empty
	 ...
	 * @param text the String to check
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the text does not contain valid text content
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the text contains the substring
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the object array is {@code null} or contains no elements
	 */
	 ...
	 * @param array the array to check
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the object array contains a {@code null} element
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the collection is {@code null} or
	 ...
	 * @param collection the collection to check
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the collection contains a {@code null} element
	 * @since 5.2
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws ResultInfoException if the map is {@code null} or contains no entries
	 */
	 ...
	 * @throws ResultInfoException if the object is not an instance of type
	 */
	 ...
	 * @throws ResultInfoException if the classes are not assignable
	 */
	...
	private static void instanceCheckFailed(Class<?> type, @Nullable Object obj, @Nullable String msg) {
		...
		throw new ResultInfoException(result);
	}
