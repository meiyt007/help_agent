                        ...
                        .map(principal -> {
                            ...
                            return sessionId.map(s -> {
                                if (principal.isPresent()) {
                                    ...
                                    try {
                                        CurrentLoginUser currentLoginUser = usernamePasswordAuthenticationToken2CurrentLoginUser((UsernamePasswordAuthenticationToken) ((OAuth2Authentication) principal.get()).getUserAuthentication());
