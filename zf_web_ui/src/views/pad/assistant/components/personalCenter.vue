      ...
      <div class="userInfoList" v-show="tabType === '1'">
        <div class="essentialinformationForm">
          ...
          >
            ...
            <el-form-item label="平均服务时长:" prop="avgServiceTime">
              <el-input v-model="userInfo.avgServiceTime"></el-input>
            </el-form-item>
            <el-form-item label="最大服务人数:" prop="maxServiceNum">
              <el-input v-model="userInfo.maxServiceNum"></el-input>
            </el-form-item>
            <el-form-item label="办公地点：" prop="servicePostion">
              <el-input v-model="userInfo.servicePostion" readonly></el-input>
            </el-form-item>
            <el-form-item label="备注：" prop="memo">
              <el-input v-model="userInfo.memo" readonly></el-input>
            </el-form-item>
          </el-form>
        </div>
      </div>
