        ...
        <div class="result">
            <div id="box" ref="scroll" >
                <div class="tableArea" ref="tableArea" v-loading="loadingTableData">
                    ...
                    <el-pagination style="margin-top: 1.5rem;text-align: right;" @size-change="handleiCloudSizeChange" @current-change="handleiCloudCurrentChange" :current-page="searchParams.pageNumber"
                        :page-sizes="[10, 20, 30, 50, 100]" :page-size="searchParams.pageSize" layout="total, sizes, prev, pager, next, jumper"
                        :total="total">
                    </el-pagination>
                </div>
            </div>
  ...
  props: {
    ...
    methods: {
        ...
        handleiCloudCurrentChange(pageNum) {
            this.searchParams.pageNumber = pageNum;
            this.getQueryAllWorkQueueList();
        },
        toOuter(name,url){
            if(name){
            ...
            queryPolicyBaseWithPage(this.searchParams)
                .then((res) => {
                    if (res.data.data.length > 0) {
                        ...
                        that.visitingRecordList = res.data.data;                        
                    }
