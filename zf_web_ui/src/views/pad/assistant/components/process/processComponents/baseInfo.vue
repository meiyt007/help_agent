 ...
 * @LastEditTime: 2022-11-10 17:09:11
 * @FilePath: \zf_web_ui\src\views\pad\assistant\components\process\baseInfo.vue
 * @Description: 来访人员详情
-->
<template>
  <div
    ...
    <div class="content" v-else>
      <ul>
        ...
        <li class="none">
            ...
            <template v-if="temporaryStorageList.length">
              <template v-for="(item, index) in temporaryStorageList">
                ...
                >
                  ...
                  <div class="detail-item">
                    <span>服务内容：</span>
                    <span v-html="item.serviceMemo"></span>
          ...
          <div class="nucleicAcidInformation none">
        ...
        <li>
          ...
          <div class="historyService">
            ...
            <template v-if="serviceHistoryInfo.length">
              <template v-for="(item, index) in serviceHistoryInfo" >
                <div
                class="detail historyInfo"
                @click="toServiceRecord(item)"
                :key="index"
                v-if="item.serviceBeginTime"
              >
                <div class="detail-item">
                  <span>来访时间：</span>
...
.base-container {
  ...
  ul {
    ...
    li {
      ...
      overflow-y: auto;
      width: 48%;
      background: linear-gradient(180deg, rgb(222, 232, 249) 0%, #f3f6f8 5%);
      box-shadow: 0px 0.4375rem 0px 0px rgb(213 238 251 / 31%);
      border-radius: 0.5rem;
      padding: 1.125rem 1.6875rem 0 1.5rem;
      box-shadow: 0 -5px 2px 0 RGBA(246, 251, 253, 1);
