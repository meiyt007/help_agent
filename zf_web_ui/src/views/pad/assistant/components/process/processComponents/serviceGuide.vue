 ...
 * @Date: 2022-11-07 14:43:49
 * @LastEditors: haoxinguo haoxinguo@zhuofansoft.com
 * @LastEditTime: 2022-11-10 16:03:47
 * @FilePath: \zf_web_ui\src\views\pad\assistant\components\process\serviceGuide.vue
 * @Description: 快捷帮办办事指南
-->
<template>
  <div
    class="content-body"
  ...
  >
    <div class="content-area guide">
      <div class="essentialinformation" ref="fadenum0">
        <!-- <p class="dialogContentTitle">事项基本信息</p> -->
        <div class="guide-title">事项基本信息<span>注：双指靠近或拉远，可实现收起与展开。</span></div>
      ...
      <div class="preinspectionConditions" ref="fadenum2">
        ...
        <div class="guide-title">办前须知</div>
      ...
      <div class="handlingProcess" ref="fadenum3">
        ...
        <div class="guide-title">办理流程</div>
      ...
      <div class="commonProblem" v-if="sxServiceQuestions" ref="fadenum5">
        ...
        <div
          class="problemList"
          v-for="(item, index) in sxServiceQuestions"
          :key="index"
        >
      ...
      <div class="materialList" ref="fadenum6">
        ...
        <div class="guide-title guide-material">材料列表
        ...
        <div class="material-list">
            <div class="item centerY" :key="index" v-for="(item, index) in materialList">
                <!-- <img v-if="item.madeMaterialType == 1" src="@/assets/images/pad/example02.png" alt=""></img> -->
                <img v-if="item.materialMustFlag == 0" src="@/assets/images/pad/example03.png" alt=""></img>
                <img v-else src="@/assets/images/pad/example02.png" alt=""></img>
                <div>
                    <div class="name centerY">
                      <span>{{item.materialName}} </span> 
                      <!-- <img
                        style="cursor: default"
                        v-show="item.madeMaterialType === 1"
                        :src="require('@/assets/images/home/exemption.png')"
                        alt=""
                      />
                      <img
                        @click="preView(item, 'empty')"
                        v-if="item.materialEmptyAddr"
                        :src="require('@/assets/images/home/emptyTable.png')"
                        alt=""
                      />
                      <img
                        @click="preView(item, 'sample')"
                        v-if="
                          item.materialSampleAddrYl ||
                          item.materialSimpleAddrYl
                        "
                    ...
                    <div class="btns">
                        ...
                        <span class="num">{{ item.paperNumber }}份</span>
                    </div>
                </div>
            </div>
        </div>
        <el-table class="none" :data="materialList" border>
          <el-table-column type="index" width="50" label="序号">
          </el-table-column>
          <template v-for="(item, index) in materialColumnList">
            ...
            <el-table-column
              ...
              :label="item.label"
              align="center"
              v-else-if="item.prop === 'materialFormat'"
              show-overflow-tooltip
            >
              <template slot-scope="scope">
                <span>{{
            ...
            <el-table-column
              ...
              :label="item.label"
              align="center"
              v-else-if="item.prop === 'materialMustFlag'"
              show-overflow-tooltip
            >
              <template slot-scope="scope">
                ...
                <p
                  ...
                  v-if="scope.row.materialMustFlag === 0"
                >
                  <span> 必要</span>
                </p>
    ...
    getEssentialinformation() {
      this.essentialinformation.forEach((item) => {
        ...
        // }
          ...
          if ( this.sxService[item.key] && this.sxService[item.key].indexOf(",") > -1) {
