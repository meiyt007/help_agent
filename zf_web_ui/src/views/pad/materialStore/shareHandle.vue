        ...
        methods:{
            ...
            serviceTurn(){
                ...
                getResourceInfo({
                    ...
                    let attaName = res.data.name;
                    let attaUrl = res.data.fastdfsUploadUrl;
                    if(!attaUrl){
                    ...
                    attaPush({
                        attaName,
                        attaUrl,
                        name:this.tableradioGroup.name,
                        cardNo:this.tableradioGroup.cardNo,
                        phone:this.tableradioGroup.phone,
                        companyName:'',
                        companyCode:''
                    }).then(item=>{
                        if(item.code == 200){
