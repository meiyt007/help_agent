    ...
    export default{
        ...
        methods:{
            ...
            serviceTurn(){
                ...
                let fileData = JSON.parse(this.fileData); 
                let attaName = fileData.materialName;
                let materialEmptyAddrUrl = fileData.materialEmptyAddrUrl;
                let materialSampleAddrYl = fileData.materialSampleAddrYl;
                if(!materialEmptyAddrUrl && !materialSampleAddrYl){
                    this.$message.warning("分享失败");
                    this.$emit('handleClose');
                    return;
                }
                if(materialEmptyAddrUrl){
                    this.pushData(attaName,materialEmptyAddrUrl,function(){
                        if(materialSampleAddrYl){
                            this.pushData(attaName,materialSampleAddrYl,function(){
            ...
            pushData(attaName,attaUrl,callBack){
                attaPush({
                    attaName,
                    attaUrl,
