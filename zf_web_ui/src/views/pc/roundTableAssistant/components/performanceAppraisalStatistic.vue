      ...
      >
        <template slot-scope="scope">
          <el-button
              ...
              @click="showServiceMessage(scope.row)"
          >查看详情</el-button>
        </template>
      </el-table-column>
...
<!--    />-->
    ...
    <el-dialog
        title="服务信息"
        :visible.sync="performanceServiceMessage"
        width="90%"
        class="guidelinesForHandlingAffairs"
        v-dialogDrag
    >
      <performanceServiceMessage
          v-if="performanceServiceMessage"
...
<script>
  import { performanceAppraisalStatisticVoList,listExp } from "@/api/modules/performanceAppraisalStatistic.js";
  /*import Treeselect from "@riophae/vue-treeselect";
  import "@riophae/vue-treeselect/dist/vue-treeselect.css";*/
  import performanceServiceMessage from "../components/performanceServiceMessage.vue";
  import handlingInformation from "@/views/pc/operationFlow/components/handlingInformation";
  export default {
    ...
    data () {
      return {
        ...
        performanceServiceMessage:false,
        // 弹出层标题
        title: "",
        workUserOid: "",
        // 查询参数
    ...
    methods: {
      ...
      showServiceMessage(row){
        let _that = this;
        _that.workUserOid = row.workUserOid;
        this.performanceServiceMessage=true;
